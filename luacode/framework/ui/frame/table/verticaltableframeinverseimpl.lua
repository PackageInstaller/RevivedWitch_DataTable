...
-- Command line: -se UTF8 luacode/framework/ui/frame/table/verticaltableframeinverseimpl.lua 
...
VerticalTableFrameInverseImpl.Ctor = function(self, interface, container, delegate, canSlide, autoAlign, viewportName)
...
VerticalTableFrameInverseImpl.Destroy = function(self)
...
VerticalTableFrameInverseImpl.ReloadAllCell = function(self)
...
VerticalTableFrameInverseImpl.MoveToTop = function(self, isAnimate)
...
VerticalTableFrameInverseImpl.MoveToBottom = function(self, isAnimate)
...
VerticalTableFrameInverseImpl.MoveDownToIndex = function(self, desIndex, isAnimate)
...
VerticalTableFrameInverseImpl.MoveTopToIndex = function(self, desIndex, isAnimate)
...
VerticalTableFrameInverseImpl.MoveToAssignedPos = function(self, pos, isAnimate)
...
VerticalTableFrameInverseImpl.GetTotalLength = function(self)
  -- function num : 0_8
  return self._totalLength
end

VerticalTableFrameInverseImpl.GetCurrentPosition = function(self)
  -- function num : 0_9
  return self._currentPosition
end

VerticalTableFrameInverseImpl.ReloadCellsAtIndex = function(self, indexList, isAnimate)
  ...
  for _,index in pairs(indexList) do
    ...
    do
      ...
      if topDelta < delta or self._totalLength < height then
...
VerticalTableFrameInverseImpl.RemoveCellsAtIndex = function(self, indexList, isAnimate)
            ...
            do
              ...
              do
                ...
                do
                  ...
                  for i = 1, index - 1 do
                    -- DECOMPILER ERROR at PC260: Confused about usage of register: R19 in 'UnsetPending'
...
VerticalTableFrameInverseImpl.InsertCellsAtIndex = function(self, indexList, isAnimate, dontMoveCurrentPosition)
...
VerticalTableFrameInverseImpl.FireEvent = function(self, eventName, ...)
...
VerticalTableFrameInverseImpl.GetTopIndex = function(self)
  -- function num : 0_14
  return self._topIndex
end

VerticalTableFrameInverseImpl.GetDownIndex = function(self)
  -- function num : 0_15
  return self._downIndex
end

VerticalTableFrameInverseImpl.SetMargin = function(self, upValue, downValue)
  -- function num : 0_16
...
VerticalTableFrameInverseImpl.OnBeginDrag = function(self, args)
  -- function num : 0_17
  self._dragDelta = 0
...
VerticalTableFrameInverseImpl.OnDrag = function(self, args)
  -- function num : 0_18 , upvalues : UIManager
...
VerticalTableFrameInverseImpl.OnEndDrag = function(self, args)
  -- function num : 0_19 , upvalues : UIManager, _ENV
...
VerticalTableFrameInverseImpl.OnPointerDown = function(self, args)
...
VerticalTableFrameInverseImpl.OnPointerUp = function(self, args)
  -- function num : 0_21
  self._sprintclickdown = false
  self:UpdateView(0)
end

VerticalTableFrameInverseImpl.OnLateUpdate = function(self, notification)
...
VerticalTableFrameInverseImpl.UpdateView = function(self, deltaTime)
...
VerticalTableFrameInverseImpl.SetCellVisible = function(self, i, logicCell, up, down)
  -- function num : 0_24
...
VerticalTableFrameInverseImpl.GetCellDialog = function(self, logicCell)
...
VerticalTableFrameInverseImpl.RecycleCell = function(self, logicCell)
...
VerticalTableFrameInverseImpl.SetSlide = function(self, slide, showSoftMask)
...
VerticalTableFrameInverseImpl.SetSoftMaskActive = function(self, showSoftMask)
  -- function num : 0_28 , upvalues : _ENV
  ((((CS.PixelNeko).Lua).SoftMaskStaticFunctions).SetSoftMaskActive)((self._viewport)._uiObject, showSoftMask)
end

VerticalTableFrameInverseImpl.RefreshUIParticleClipper = function(self)
...
VerticalTableFrameInverseImpl.ClearAllPositionChangeTask = function(self)
  -- function num : 0_30
  self._slideInertiaTask = nil
  self._sprintTask = nil
  self._moveTopTask = nil
