...
-- Command line: -se UTF8 luacode/localprotocols/process/action/srolechangeshapeandattribute.lua 

-- params : ...
-- function num : 0 , upvalues : _ENV
local SRoleChangeShapeAndAttribute = require("localprotocols.def.action.srolechangeshapeandattribute")
SRoleChangeShapeAndAttribute.Process = function(self, controller)
