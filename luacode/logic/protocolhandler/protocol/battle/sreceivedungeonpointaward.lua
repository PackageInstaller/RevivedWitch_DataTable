...
-- Command line: -se UTF8 luacode/logic/protocolhandler/protocol/battle/sreceivedungeonpointaward.lua 
...
local p1 = function(protocol)
  ...
  do
    ...
    ;
    (LuaNotificationCenter.PostNotification)(Common.n_ReceiveDungeonPointAward, nil, {id = protocol.id})
  end
end
