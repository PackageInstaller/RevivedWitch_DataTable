...
-- Command line: -se UTF8 luacode/logic/protocolhandler/protocol/login/sroleupdatelv.lua 
...
local p1 = function(protocol)
  ...
  userInfo.levelandexp = {level = protocol.level, exp = protocol.exp, key = protocol.roleId}
  ;
