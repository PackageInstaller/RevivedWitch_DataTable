...
-- Command line: -se UTF8 luacode/logic/dialog/welfare/nationdaysignactivitytabcell.lua 
...
NationDaySignActivityTabCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : NationDaySignActivityTabCell
...
NationDaySignActivityTabCell.OnCreate = function(self)
  -- function num : 0_1
...
NationDaySignActivityTabCell.OnDestroy = function(self)
...
NationDaySignActivityTabCell.RefreshTabCell = function(self, activityId, refresh, refreshByProtocol)
...
NationDaySignActivityTabCell.OnCellClick = function(self, index)
...
NationDaySignActivityTabCell.GetCanGetFirstIndex = function(self)
...
NationDaySignActivityTabCell.RefreshTime = function(self)
...
NationDaySignActivityTabCell.OnAnimationStateExit = function(self, handle, stateName, normalizedTime)
...
NationDaySignActivityTabCell.OnEffectEnd = function(self, index, window, effectHandler)
