...
-- Command line: -se UTF8 luacode/logic/dialog/welfare/beforechristmassignactivitytabcell.lua 
...
BeforeChristmasSignActivityTabCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : BeforeChristmasSignActivityTabCell
...
BeforeChristmasSignActivityTabCell.OnCreate = function(self)
  -- function num : 0_1
...
BeforeChristmasSignActivityTabCell.OnDestroy = function(self)
...
BeforeChristmasSignActivityTabCell.RefreshTabCell = function(self, activityId, refresh, refreshByProtocol)
...
BeforeChristmasSignActivityTabCell.OnCellClick = function(self, index)
...
BeforeChristmasSignActivityTabCell.GetCanGetFirstIndex = function(self)
...
BeforeChristmasSignActivityTabCell.RefreshTime = function(self)
...
BeforeChristmasSignActivityTabCell.OnAnimationStateExit = function(self, handle, stateName, normalizedTime)
...
BeforeChristmasSignActivityTabCell.OnEffectEnd = function(self, index, window, effectHandler)
