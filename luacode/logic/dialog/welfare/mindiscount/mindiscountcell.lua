...
-- Command line: -se UTF8 luacode/logic/dialog/welfare/mindiscount/mindiscountcell.lua 
...
MinDiscountcell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : MinDiscountcell
  ((MinDiscountcell.super).Ctor)(self, ...)
end

MinDiscountcell.OnCreate = function(self)
  -- function num : 0_1
...
MinDiscountcell.OnDestroy = function(self)
  -- function num : 0_2
end

MinDiscountcell.RefreshCell = function(self, data)
...
MinDiscountcell.OnCellClicked = function(self)
