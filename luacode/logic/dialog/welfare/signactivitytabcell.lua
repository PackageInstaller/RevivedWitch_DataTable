...
-- Command line: -se UTF8 luacode/logic/dialog/welfare/signactivitytabcell.lua 
...
SignActivityTabCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : SignActivityTabCell
...
SignActivityTabCell.OnCreate = function(self)
  -- function num : 0_1 , upvalues : roleDay, roleDay2
...
SignActivityTabCell.OnDestroy = function(self)
...
local SetNodeActive = function(cell, get, select, grey)
  -- function num : 0_3 , upvalues : roleDay, roleDay2
...
SignActivityTabCell.RefreshTabCell = function(self, activityId, refresh, refreshByProtocol)
  -- function num : 0_5 , upvalues : _ENV, CTotalLoginActivity, CWelfareTabCfg, CImagePathTable, SetNodeActive, PlayEnableReceiveEffect, Item, roleDay, roleDay2
  local tag = nil
...
SignActivityTabCell.OnCellClick = function(self, index)
  -- function num : 0_6 , upvalues : roleDay, roleDay2, _ENV, Item
  local data = (self._itemList)[index]
  if index == roleDay then
    self:OnRoleDetailBtnClick(roleDay)
  else
    if index == roleDay2 then
...
SignActivityTabCell.OnRoleDetailBtnClick = function(self, roleday)
  -- function num : 0_7 , upvalues : _ENV, CRoleItemTable
  ...
  local roleIDList = {(CRoleItemTable:GetRecorder(((self._itemList)[roleday]).itemId)).roleid}
  local cfgIDList = {4}
  roleInfoDialog:Init({roleIdList = roleIDList, cfgIdList = cfgIDList, index = 1}, (CheckOtherRoleInfoDialog.ShowType).BaseLevelInfo)
end

SignActivityTabCell.OnTitleRoleDetailBtnClick = function(self)
  -- function num : 0_8 , upvalues : roleDay2
  self:OnRoleDetailBtnClick(roleDay2)
end

SignActivityTabCell.GetCanGetFirstIndex = function(self)
...
SignActivityTabCell.RefreshTime = function(self)
...
SignActivityTabCell.OnAnimationStateExit = function(self, handle, stateName, normalizedTime)
...
SignActivityTabCell.OnEffectEnd = function(self, index, window, effectHandler)
