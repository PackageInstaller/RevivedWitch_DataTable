...
-- Command line: -se UTF8 luacode/logic/dialog/smallbattle/smallbattledialog.lua 
...
SmallBattleDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : SmallBattleDialog
  ((SmallBattleDialog.super).Ctor)(self, ...)
  self._groupName = "Modal"
end

SmallBattleDialog.OnCreate = function(self)
...
SmallBattleDialog.OnDestroy = function(self)
...
SmallBattleDialog.SetData = function(self, target, serverResult, data, charlist, score)
  -- function num : 0_3 , upvalues : SmallBattleDialog, _ENV, charNumber, Role, CStringRes, TransformStaticFunctions, EventTriggerHelper, AnimatorStaticFunctions, CMonster_Handbook, CNPCShape, CClownSpecialCfg
  self._target = target
  ...
  for _,c in ipairs(self._leftQueue) do
    if (self._char)[i] then
      ...
      -- DECOMPILER ERROR at PC191: Confused about usage of register: R14 in 'UnsetPending'
...
SmallBattleDialog.OnAnimationStateExit = function(self, handle, stateName, normalizedTime)
...
SmallBattleDialog.OnPrefabModelAnimationStateExit = function(self, handle, stateName, normalizedTime)
  -- function num : 0_5
...
SmallBattleDialog.OnInjuryNumAnimationStateExit = function(self, index, handle, stateName, normalizedTime)
  -- function num : 0_6
...
SmallBattleDialog.OnSkipBtnClicked = function(self)
  -- function num : 0_7
  self:Quit()
end

SmallBattleDialog.Act = function(self)
...
SmallBattleDialog.MakeBattleOpList = function(self)
...
SmallBattleDialog.Quit = function(self)
  ...
  if self._result == ResultType.Failed then
    ...
    if self._result == ResultType.Success then
...
SmallBattleDialog.RealQuit = function(self)
  -- function num : 0_11 , upvalues : _ENV
  (LuaNotificationCenter.PostNotification)(Common.n_AprilFoolsClientBattleProcessOver, self, nil)
  self:Destroy()
end

SmallBattleDialog.OnDialogWillDestroy = function(self, notification)
  -- function num : 0_12
