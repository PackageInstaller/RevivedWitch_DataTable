...
-- Command line: -se UTF8 luacode/logic/dialog/equip/equiplistskillcell.lua 
...
EquipListSkillCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipListSkillCell
  ((EquipListSkillCell.super).Ctor)(self, ...)
end

EquipListSkillCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipListSkillCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipListSkillCell.RefreshCell = function(self, data)
