...
-- Command line: -se UTF8 luacode/logic/dialog/equip/equiptipworddescribecell.lua 
...
EquipTipWordDescribeCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipTipWordDescribeCell
  ((EquipTipWordDescribeCell.super).Ctor)(self, ...)
end

EquipTipWordDescribeCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipTipWordDescribeCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipTipWordDescribeCell.RefreshCell = function(self, data)
