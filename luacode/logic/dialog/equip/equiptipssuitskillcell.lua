...
-- Command line: -se UTF8 luacode/logic/dialog/equip/equiptipssuitskillcell.lua 
...
EquipTipsSuitSkillCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipTipsSuitSkillCell
  ((EquipTipsSuitSkillCell.super).Ctor)(self, ...)
end

EquipTipsSuitSkillCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipTipsSuitSkillCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipTipsSuitSkillCell.RefreshCell = function(self, data)
