...
-- Command line: -se UTF8 luacode/logic/dialog/equip/equipchangeskillcell.lua 
...
EquipChangeSkillCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipChangeSkillCell
  ((EquipChangeSkillCell.super).Ctor)(self, ...)
end

EquipChangeSkillCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipChangeSkillCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipChangeSkillCell.RefreshCell = function(self, data)
