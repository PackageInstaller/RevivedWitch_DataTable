...
-- Command line: -se UTF8 luacode/logic/dialog/alchemy/productaccountcell.lua 
...
ProductAccountCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ProductAccountCell
  ((ProductAccountCell.super).Ctor)(self, ...)
end

ProductAccountCell.OnCreate = function(self)
  -- function num : 0_1
...
ProductAccountCell.OnDestroy = function(self)
  -- function num : 0_2 , upvalues : _ENV
  (LuaNotificationCenter.RemoveObserver)(self)
end

ProductAccountCell.RefreshCell = function(self, data)
  -- function num : 0_3
...
ProductAccountCell.OnCellClicked = function(self, args)
...
ProductAccountCell.OnEvent = function(self, eventName, arg)
...
ProductAccountCell.ChangeCellSelected = function(self, notification)
