...
-- Command line: -se UTF8 luacode/logic/dialog/invite/inviteshareresultdlg.lua 
...
InviteShareDialog.Init = function(self, showShareInfo, invideCode, shared)
  -- function num : 0_3 , upvalues : _ENV, HeadPhotoTable, cimagepath, HeadPhotoFrameTable, CShareReward, Item, InviteUtil
        ...
        if headPhotoFrameRecord then
          ...
          do
            ...
            do
              ...
              ;
              (InviteUtil.SetItemInfo)(self._itemCell, {item = item, num = (record.itemNum)[1]})
