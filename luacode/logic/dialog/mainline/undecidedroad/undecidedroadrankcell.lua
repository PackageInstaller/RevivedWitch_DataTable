...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/undecidedroad/undecidedroadrankcell.lua 
...
UndecidedRoadRankCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : UndecidedRoadRankCell
  ((UndecidedRoadRankCell.super).Ctor)(self, ...)
  self._groupName = "Cell"
end

UndecidedRoadRankCell.OnCreate = function(self)
...
UndecidedRoadRankCell.OnDestroy = function(self)
  -- function num : 0_2
end

UndecidedRoadRankCell.RefreshCell = function(self)
...
UndecidedRoadRankCell.OnTeamClicked = function(self)
