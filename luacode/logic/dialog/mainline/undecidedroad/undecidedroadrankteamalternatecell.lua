...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/undecidedroad/undecidedroadrankteamalternatecell.lua 
...
UndecidedRoadRankTeamAlternateCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : UndecidedRoadRankTeamAlternateCell
  ((UndecidedRoadRankTeamAlternateCell.super).Ctor)(self, ...)
end

UndecidedRoadRankTeamAlternateCell.OnCreate = function(self)
  -- function num : 0_1
...
UndecidedRoadRankTeamAlternateCell.OnDestroy = function(self)
  -- function num : 0_2
end

UndecidedRoadRankTeamAlternateCell.RefreshCell = function(self, data)
...
UndecidedRoadRankTeamAlternateCell.OnCellClicked = function(self)
