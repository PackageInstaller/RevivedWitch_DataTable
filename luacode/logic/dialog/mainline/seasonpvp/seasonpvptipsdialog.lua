...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/seasonpvp/seasonpvptipsdialog.lua 
...
SeasonPvpTipsDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : SeasonPvpTipsDialog
  ((SeasonPvpTipsDialog.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

SeasonPvpTipsDialog.OnCreate = function(self)
...
SeasonPvpTipsDialog.OnDestroy = function(self)
  -- function num : 0_2
end

SeasonPvpTipsDialog.OnBackBtnClicked = function(self)
  -- function num : 0_3
  self:Destroy()
end

SeasonPvpTipsDialog.SetData = function(self, contentTextID)
...
SeasonPvpTipsDialog.OnCurPosChange = function(self, frame, proportion)
  -- function num : 0_5
