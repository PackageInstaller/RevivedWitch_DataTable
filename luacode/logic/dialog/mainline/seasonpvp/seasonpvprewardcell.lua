...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/seasonpvp/seasonpvprewardcell.lua 
...
SeasonPvpRewardCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : SeasonPvpRewardCell
  ((SeasonPvpRewardCell.super).Ctor)(self, ...)
end

SeasonPvpRewardCell.OnCreate = function(self)
...
SeasonPvpRewardCell.OnDestroy = function(self)
  -- function num : 0_2
end

SeasonPvpRewardCell.RefreshCell = function(self, data)
...
SeasonPvpRewardCell.OnCellClicked = function(self)
