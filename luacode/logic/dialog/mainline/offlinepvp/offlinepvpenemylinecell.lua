...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/offlinepvp/offlinepvpenemylinecell.lua 
...
OffLinePVPEnemyLineCell.Ctor = function(self, ...)
  -- function num : 0_1 , upvalues : OffLinePVPEnemyLineCell
  ((OffLinePVPEnemyLineCell.super).Ctor)(self, ...)
  self._handler = 0
end

OffLinePVPEnemyLineCell.OnCreate = function(self)
  -- function num : 0_2
...
OffLinePVPEnemyLineCell.OnDestroy = function(self)
  -- function num : 0_3
end

OffLinePVPEnemyLineCell.RefreshCell = function(self, data)
...
OffLinePVPEnemyLineCell.OnCellClicked = function(self)
