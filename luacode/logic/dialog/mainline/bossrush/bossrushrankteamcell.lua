...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/bossrush/bossrushrankteamcell.lua 
...
BossRushRankTeamRoleCell.Ctor = function(self, ...)
  -- function num : 0_1 , upvalues : BossRushRankTeamRoleCell
  ((BossRushRankTeamRoleCell.super).Ctor)(self, ...)
  self._handler = 0
end

BossRushRankTeamRoleCell.OnCreate = function(self)
  -- function num : 0_2
...
BossRushRankTeamRoleCell.OnDestroy = function(self)
  -- function num : 0_3
end

BossRushRankTeamRoleCell.RefreshCell = function(self, data)
...
BossRushRankTeamRoleCell.OnCellClicked = function(self)
