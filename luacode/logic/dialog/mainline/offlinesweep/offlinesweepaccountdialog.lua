...
-- Command line: -se UTF8 luacode/logic/dialog/mainline/offlinesweep/offlinesweepaccountdialog.lua 
...
OfflineSweepAccountDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : OfflineSweepAccountDialog, _ENV
...
OfflineSweepAccountDialog.OnCreate = function(self)
...
OfflineSweepAccountDialog.OnDestroy = function(self)
...
local SortItemByPinji = function(self)
  ...
  (table.sort)(self._data, function(a, b)
    -- function num : 0_3_1 , upvalues : gettempFun
    return gettempFun(a.item, b.item)
  end
)
end

OfflineSweepAccountDialog.Init = function(self)
  -- function num : 0_4 , upvalues : _ENV, SortItemByPinji, Item, CStringRes
...
OfflineSweepAccountDialog.NumberOfCell = function(self, frame)
  -- function num : 0_5
...
OfflineSweepAccountDialog.CellAtIndex = function(self, frame, index)
  -- function num : 0_6
  if frame == self._itemFrame then
...
OfflineSweepAccountDialog.DataAtIndex = function(self, frame, index)
  -- function num : 0_7
...
OfflineSweepAccountDialog.OnNextClicked = function(self)
  -- function num : 0_8
  self:Destroy()
end

OfflineSweepAccountDialog.OnTipsDestroy = function(self, notification)
  -- function num : 0_9
...
OfflineSweepAccountDialog.SetSelectedID = function(self, args)
  -- function num : 0_10
  (self._itemFrame):FireEvent("SetItemSelectedState", args)
end

OfflineSweepAccountDialog.SetNotSelect = function(self)
  -- function num : 0_11
  (self._itemFrame):FireEvent("SetItemSelectedState", nil)
end
