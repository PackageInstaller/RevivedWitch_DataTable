...
-- Command line: -se UTF8 luacode/logic/dialog/shop/uniqueequipbuyattrcell.lua 
...
UniqueEquipBuyAttrCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : UniqueEquipBuyAttrCell
  ((UniqueEquipBuyAttrCell.super).Ctor)(self, ...)
end

UniqueEquipBuyAttrCell.OnCreate = function(self)
  -- function num : 0_1
...
UniqueEquipBuyAttrCell.OnDestroy = function(self)
  -- function num : 0_2
end

UniqueEquipBuyAttrCell.RefreshCell = function(self, data)
