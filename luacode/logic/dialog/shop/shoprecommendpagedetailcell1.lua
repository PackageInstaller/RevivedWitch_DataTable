...
-- Command line: -se UTF8 luacode/logic/dialog/shop/shoprecommendpagedetailcell1.lua 
...
ShopRecommendPageDetailCell1.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ShopRecommendPageDetailCell1
  ((ShopRecommendPageDetailCell1.super).Ctor)(self, ...)
  self._itemsData1 = {}
  self._itemsData2 = {}
end

ShopRecommendPageDetailCell1.OnCreate = function(self)
...
ShopRecommendPageDetailCell1.OnDestroy = function(self)
  -- function num : 0_2
...
ShopRecommendPageDetailCell1.RefreshCell = function(self, data)
...
ShopRecommendPageDetailCell1.OnClick = function(self)
...
ShopRecommendPageDetailCell1.NumberOfCell = function(self, frame)
  -- function num : 0_5
...
ShopRecommendPageDetailCell1.CellAtIndex = function(self, frame, index)
  -- function num : 0_6
  return "shop.recommendshoppageitemcell"
end

ShopRecommendPageDetailCell1.DataAtIndex = function(self, frame, index)
  -- function num : 0_7
  if frame == self._itemsFrame1 then
...
ShopRecommendPageDetailCell1.PlayShowAnimation = function(self)
  -- function num : 0_8
