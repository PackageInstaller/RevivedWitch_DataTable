...
-- Command line: -se UTF8 luacode/logic/dialog/common/equipfilterframe.lua 
...
EquipFilterFrame.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipFilterFrame
  ((EquipFilterFrame.super).Ctor)(self, ...)
end

EquipFilterFrame.OnCreate = function(self)
...
EquipFilterFrame.OnDestroy = function(self)
  -- function num : 0_2
  (self._frame):Destroy()
end

EquipFilterFrame.RefreshCell = function(self, data)
...
EquipFilterFrame.NumberOfCell = function(self, frame)
  -- function num : 0_4
  return #(self._cellData).list
end

EquipFilterFrame.CellAtIndex = function(self, frame, index)
  -- function num : 0_5
  return "common.equipfilterframecell"
end

EquipFilterFrame.DataAtIndex = function(self, frame, index)
  -- function num : 0_6
  return ((self._cellData).list)[index]
end

EquipFilterFrame.OnEvent = function(self, eventName, arg)
  -- function num : 0_7
