...
-- Command line: -se UTF8 luacode/logic/dialog/common/filterframe.lua 
...
FilterFrame.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : FilterFrame
  ((FilterFrame.super).Ctor)(self, ...)
end

FilterFrame.OnCreate = function(self)
...
FilterFrame.OnDestroy = function(self)
  -- function num : 0_2
  (self._frame):Destroy()
end

FilterFrame.RefreshCell = function(self, data)
...
FilterFrame.NumberOfCell = function(self, frame)
  -- function num : 0_4
  return #(self._cellData).list
end

FilterFrame.CellAtIndex = function(self, frame, index)
  -- function num : 0_5
  return "common.filterframecell"
end

FilterFrame.DataAtIndex = function(self, frame, index)
  -- function num : 0_6
  return ((self._cellData).list)[index]
end

FilterFrame.OnEvent = function(self, eventName, arg)
  -- function num : 0_7
