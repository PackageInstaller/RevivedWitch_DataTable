...
-- Command line: -se UTF8 luacode/logic/dialog/chat/chatselfcell.lua 
...
ChatSelfCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ChatSelfCell
...
ChatSelfCell.OnCreate = function(self)
  -- function num : 0_1
...
ChatSelfCell.OnDestroy = function(self)
  -- function num : 0_2
end

ChatSelfCell.RefreshCell = function(self, data)
...
ChatSelfCell.OnBeginLongPress = function(self, args)
  -- function num : 0_4
