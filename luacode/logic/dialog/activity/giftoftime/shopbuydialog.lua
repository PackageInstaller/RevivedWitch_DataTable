...
-- Command line: -se UTF8 luacode/logic/dialog/activity/giftoftime/shopbuydialog.lua 
...
ItemGiftBuyDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ItemGiftBuyDialog
  ((ItemGiftBuyDialog.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

ItemGiftBuyDialog.OnCreate = function(self)
...
ItemGiftBuyDialog.OnDestroy = function(self)
  -- function num : 0_2
  (self._cellFrame):Destroy()
end

ItemGiftBuyDialog.SetData = function(self, iteminfo, shopid)
  -- function num : 0_3 , upvalues : CPackage, Item, _ENV
...
ItemGiftBuyDialog.NumberOfCell = function(self, frame)
  -- function num : 0_4
  return #(self._itemInfo).itemId
end

ItemGiftBuyDialog.CellAtIndex = function(self, frame, index)
  -- function num : 0_5
  return "shop.dailygiftbuycell"
end

ItemGiftBuyDialog.DataAtIndex = function(self, frame, index)
  -- function num : 0_6
  local data = {}
...
ItemGiftBuyDialog.OnBuyBtnClicked = function(self)
...
ItemGiftBuyDialog.OnRoleBtnClicked = function(self)
...
ItemGiftBuyDialog.OnDialogClicked = function(self, args)
...
ItemGiftBuyDialog.OnBackBtnClicked = function(self)
