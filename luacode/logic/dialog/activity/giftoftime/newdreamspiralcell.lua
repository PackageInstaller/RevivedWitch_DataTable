...
-- Command line: -se UTF8 luacode/logic/dialog/activity/giftoftime/newdreamspiralcell.lua 
...
NewDreamSpiralCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : NewDreamSpiralCell
  ((NewDreamSpiralCell.super).Ctor)(self, ...)
end

NewDreamSpiralCell.OnCreate = function(self)
  -- function num : 0_1
...
NewDreamSpiralCell.OnDestroy = function(self)
  -- function num : 0_2
end

NewDreamSpiralCell.SetItem = function(self, obj, data)
...
NewDreamSpiralCell.SetCharInfo = function(self, obj, data, type)
  -- function num : 0_4
  if not obj then
    return 
  end
...
NewDreamSpiralCell.OnCellClicked = function(self, kind)
...
NewDreamSpiralCell.RefreshCell = function(self, data)
  -- function num : 0_8 , upvalues : Collection, _ENV, Item, UniqueEquip, Role, CRoleItem, CSkinItem, CSkin, CImagePathTable, CNpcShapeTable
  self._data = data
  ;
...
NewDreamSpiralCell.OnEvent = function(self, eventName, arg)
  -- function num : 0_9
