...
-- Command line: -se UTF8 luacode/logic/dialog/activity/doubleeleven/itembuydialog.lua 
...
ItemBuyDialog.OnBuyBtnClicked = function(self)
  ...
  if (self._data).discount == -1 or (self._data).discount == 10 and (self._data).discountPrice == 0 then
    ...
    ;
    (LuaNotificationCenter.PostNotification)(Common.n_RefreshActivityShopRedDot, nil, {activityId = (DataCommon.Activities).DoubleEleven})
  end
