...
-- Command line: -se UTF8 luacode/logic/dialog/activity/starmirage/accumulaterewarddialog.lua 
...
AccumulateRewardDialog.OnCreate = function(self)
  ...
  for i = 1, 3 do
    do
      ...
      ;
      ((self._mainRewardItems)[i]).cell = self:GetChild("BackImage/Reward/ItemCell" .. R9_PC81)
      -- DECOMPILER ERROR at PC92: Confused about usage of register: R5 in 'UnsetPending'

      ;
      ((self._mainRewardItems)[i]).frame = self:GetChild("BackImage/Reward/ItemCell" .. R9_PC81 .. "/_BackGround/Frame")
      ...
      ;
      ((self._mainRewardItems)[i]).icon = self:GetChild("BackImage/Reward/ItemCell" .. R9_PC81 .. "/_BackGround/Icon")
      ;
