...
-- Command line: -se UTF8 luacode/logic/dialog/activity/starmirage/rankteaminfodialog.lua 
...
RankTeamInfoDialog.InitDataInfo = function(self, difficultyColorStrType, data, levelId)
  -- function num : 0_3 , upvalues : HeadPhotoTable, CImagePathTable, _ENV, HeadPhotoFrameTable, CStarryMirrorRanking, CNPCShape, RankType
