...
-- Command line: -se UTF8 luacode/logic/dialog/activity/starmirage/easytabcell.lua 
...
EasyTabCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EasyTabCell, CStarrymirrorlevel, _ENV, CEventBoostRole
...
EasyTabCell.OnCreate = function(self)
  -- function num : 0_1 , upvalues : _ENV, CStarryMirrorDiffculty, TableFrame
...
EasyTabCell.OnDestroy = function(self)
...
EasyTabCell.OnRefreshSpirit = function(self, notification)
  -- function num : 0_3
...
EasyTabCell.OnNPCChatEnd = function(self, notification)
  -- function num : 0_5 , upvalues : _ENV, EnterTeamEdit
...
EasyTabCell.RefreshActivityRewards = function(self)
...
EasyTabCell.RefreshByProtocol = function(self, data)
...
EasyTabCell.RefreshTabCell = function(self, data, notSelectLevel, refresh)
...
EasyTabCell.SelectLevelById = function(self, levelId)
...
EasyTabCell.OnUpdate = function(self, notification)
...
EasyTabCell.OnAutoBtnClicked = function(self)
...
EasyTabCell.OnAutoBtnClickAreaClicked = function(self)
...
EasyTabCell.OnGoBtnClicked = function(self)
...
EasyTabCell.OnAccumulateRewardBtnClicked = function(self)
  -- function num : 0_17 , upvalues : _ENV
  (DialogManager.CreateSingletonDialog)("activity.starmirage.accumulaterewarddialog")
end

EasyTabCell.OnShopBtnClicked = function(self)
...
EasyTabCell.OnRankBtnClicked = function(self)
...
EasyTabCell.ResourceSelectDetailShow = function(self)
  -- function num : 0_20 , upvalues : RefreshDetailPanel
...
EasyTabCell.OnStateExit = function(self, handler, stateName, normalizedTime)
  -- function num : 0_21 , upvalues : _ENV, BossLevelId, LevelStateEnum
...
EasyTabCell.NumberOfCell = function(self, frame, index)
  -- function num : 0_22
...
EasyTabCell.CellAtIndex = function(self, frame, index)
  -- function num : 0_23
  if frame == self._roleAddPanel_frame then
...
EasyTabCell.DataAtIndex = function(self, frame, index)
  -- function num : 0_24
  if frame == self._roleAddPanel_frame then
