...
-- Command line: -se UTF8 luacode/logic/dialog/activity/starmirage/levelcell.lua 
  ...
  if self._status == LevelStateEnum.LOCK then
    ...
    if self._status ~= LevelStateEnum.PASSED then
      ...
      do
        ...
        if (self._bm):IsPlayGuideClickEffect() and self._levelId == 10000 and not self._handler then
