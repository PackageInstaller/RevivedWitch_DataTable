...
-- Command line: -se UTF8 luacode/logic/dialog/activity/activitycommon/shopgoodscell.lua 
...
ShopGoodsCell.RefreshCell = function(self, data)
  -- function num : 0_3 , upvalues : CImagePathTable, _ENV, CSugarShopOpen, Item, CCurrencySymbol, CStringRes
  self._data = data
  self._hasSkin = false
...
ShopGoodsCell.OnFashionBtnClicked = function(self)
