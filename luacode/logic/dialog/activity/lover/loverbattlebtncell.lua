...
-- Command line: -se UTF8 luacode/logic/dialog/activity/lover/loverbattlebtncell.lua 
...
LoverBattleBtnCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : LoverBattleBtnCell
  ((LoverBattleBtnCell.super).Ctor)(self, ...)
end

LoverBattleBtnCell.OnCreate = function(self)
  -- function num : 0_1
...
LoverBattleBtnCell.OnDestroy = function(self)
  -- function num : 0_2
end

LoverBattleBtnCell.RefreshCell = function(self, data)
...
LoverBattleBtnCell.OnCellClicked = function(self)
  -- function num : 0_4
  (self._delegate):OnButtonGroupClick((self._cellData).index)
end

LoverBattleBtnCell.OnEvent = function(self, eventName, arg)
  -- function num : 0_5
