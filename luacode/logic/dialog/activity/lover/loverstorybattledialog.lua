...
-- Command line: -se UTF8 luacode/logic/dialog/activity/lover/loverstorybattledialog.lua 
...
LoverStoryBattleDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : LoverStoryBattleDialog
  ((LoverStoryBattleDialog.super).Ctor)(self, ...)
  self._groupName = "Modal"
end

LoverStoryBattleDialog.OnCreate = function(self)
...
LoverStoryBattleDialog.OnDestroy = function(self)
...
LoverStoryBattleDialog.SetData = function(self, data)
  -- function num : 0_3 , upvalues : CLoverInterfaceFunction, CHexagonBattleConfig, _ENV, CRoleLevelCfgTable
...
LoverStoryBattleDialog.OnCheckbtnClicked = function(self)
...
LoverStoryBattleDialog.OnEveryWhereClick = function(self, args)
...
LoverStoryBattleDialog.OnBackBtnClicked = function(self)
  -- function num : 0_6
  self:Destroy()
end

LoverStoryBattleDialog.NumberOfCell = function(self, frame)
  -- function num : 0_7
  return #self._itemData
end

LoverStoryBattleDialog.CellAtIndex = function(self, frame, index)
  -- function num : 0_8
  return "activity.lover.loverbattleitemcell"
end

LoverStoryBattleDialog.DataAtIndex = function(self, frame, index)
  -- function num : 0_9
  return (self._itemData)[index]
end

LoverStoryBattleDialog.OnTipsBtnClicked = function(self)
  -- function num : 0_10 , upvalues : CLoverInterfaceFunction, _ENV
