...
-- Command line: -se UTF8 luacode/logic/dialog/activity/lover/shopitemcell.lua 
...
local isLock = function(self)
  -- function num : 0_0 , upvalues : _ENV, Item
  local recoder = nil
  local curNum = 0
  self._nameStr = ""
  if (self._data).moneyType == DataCommon.LoveTownCurrency then
    ...
    do
      do
        if (self._data).moneyType == DataCommon.LoveChocolate then
...
ShopItemCell.OnCellClicked = function(self)
  -- function num : 0_5 , upvalues : ShopTypeMap, _ENV
