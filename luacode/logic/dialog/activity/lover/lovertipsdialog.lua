...
-- Command line: -se UTF8 luacode/logic/dialog/activity/lover/lovertipsdialog.lua 
...
LoverTipsDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : LoverTipsDialog
  ((LoverTipsDialog.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

LoverTipsDialog.OnCreate = function(self)
...
LoverTipsDialog.SetStaticRes = function(self)
  -- function num : 0_2 , upvalues : _ENV, CStringRes
  (self._title):SetText((TextManager.GetText)((CStringRes:GetRecorder(1698)).msgTextID))
end

LoverTipsDialog.OnDestroy = function(self)
  -- function num : 0_3
end

LoverTipsDialog.OnBackBtnClicked = function(self)
  -- function num : 0_4
  self:Destroy()
end

LoverTipsDialog.SetData = function(self, textID)
...
LoverTipsDialog.OnCurPosChange = function(self, frame, proportion)
  -- function num : 0_6
