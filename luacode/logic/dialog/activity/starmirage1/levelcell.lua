...
-- Command line: -se UTF8 luacode/logic/dialog/activity/starmirage1/levelcell.lua 
  ...
  if self._status == LevelStateEnum.LOCK then
    ...
    if self._status ~= LevelStateEnum.PASSED then
      ...
      do
        ...
        if (self._bm):IsPlayGuideClickEffect() and self._levelId == (self._bm):GetFirstLevelId() and not self._handler then
