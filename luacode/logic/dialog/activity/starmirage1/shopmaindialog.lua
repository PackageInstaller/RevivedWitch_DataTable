...
-- Command line: -se UTF8 luacode/logic/dialog/activity/starmirage1/shopmaindialog.lua 
...
local ShopType = {[ShopTypeMap.Easy] = (((DataCommon.StarMirage1)[(DataCommon.Activities).StarMirageCopy]).Type).Easy, [ShopTypeMap.Hard] = (((DataCommon.StarMirage1)[(DataCommon.Activities).StarMirageCopy]).Type).Hard}
...
ShopMainDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ShopMainDialog, _ENV, CStarryMirrorDiffculty
...
ShopMainDialog.RefreshCurrencyPanel = function(self)
  -- function num : 0_3 , upvalues : _ENV, ShopType
...
ShopMainDialog.OnBuyShopGood = function(self, notification)
  -- function num : 0_5 , upvalues : _ENV, ShopTypeMap
