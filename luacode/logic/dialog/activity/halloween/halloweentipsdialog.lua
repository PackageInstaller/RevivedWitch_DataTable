...
-- Command line: -se UTF8 luacode/logic/dialog/activity/halloween/halloweentipsdialog.lua 
...
HalloweenTipsDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : HalloweenTipsDialog
  ((HalloweenTipsDialog.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

HalloweenTipsDialog.OnCreate = function(self)
...
HalloweenTipsDialog.SetStaticRes = function(self)
  -- function num : 0_2 , upvalues : _ENV, CStringRes
  (self._title):SetText((TextManager.GetText)((CStringRes:GetRecorder(1636)).msgTextID))
end

HalloweenTipsDialog.OnDestroy = function(self)
  -- function num : 0_3
end

HalloweenTipsDialog.OnBackBtnClicked = function(self)
  -- function num : 0_4
  self:Destroy()
end

HalloweenTipsDialog.SetData = function(self, textID)
...
HalloweenTipsDialog.OnCurPosChange = function(self, frame, proportion)
  -- function num : 0_6
