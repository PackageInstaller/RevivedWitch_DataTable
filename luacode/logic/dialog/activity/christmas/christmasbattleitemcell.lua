...
-- Command line: -se UTF8 luacode/logic/dialog/activity/christmas/christmasbattleitemcell.lua 
...
ChristmasBattleItemCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ChristmasBattleItemCell
  ((ChristmasBattleItemCell.super).Ctor)(self, ...)
end

ChristmasBattleItemCell.OnCreate = function(self)
  -- function num : 0_1
...
ChristmasBattleItemCell.OnDestroy = function(self)
  -- function num : 0_2
end

ChristmasBattleItemCell.RefreshCell = function(self, data)
...
ChristmasBattleItemCell.OnCellClicked = function(self)
