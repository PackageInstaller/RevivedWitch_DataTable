...
-- Command line: -se UTF8 luacode/logic/dialog/activity/christmas/rankteaminfodialog.lua 
...
RankTeamInfoDialog.InitDataInfo = function(self, data, levelId)
  -- function num : 0_3 , upvalues : HeadPhotoTable, CImagePathTable, _ENV, HeadPhotoFrameTable, CChrisBossRush, CNPCShape, RankType
