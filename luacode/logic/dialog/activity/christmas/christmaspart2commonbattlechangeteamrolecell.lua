...
-- Command line: -se UTF8 luacode/logic/dialog/activity/christmas/christmaspart2commonbattlechangeteamrolecell.lua 
...
ChristmasPart2CommonBattleChangeTeamRoleCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ChristmasPart2CommonBattleChangeTeamRoleCell
  ((ChristmasPart2CommonBattleChangeTeamRoleCell.super).Ctor)(self, ...)
  self._sameTag = false
end

ChristmasPart2CommonBattleChangeTeamRoleCell.OnCreate = function(self)
  -- function num : 0_1
...
ChristmasPart2CommonBattleChangeTeamRoleCell.OnDestroy = function(self)
  -- function num : 0_2 , upvalues : _ENV
  (LuaNotificationCenter.RemoveObserver)(self)
end

ChristmasPart2CommonBattleChangeTeamRoleCell.RefreshCell = function(self, data)
...
ChristmasPart2CommonBattleChangeTeamRoleCell.IsSameWithTeamRoles = function(self)
...
ChristmasPart2CommonBattleChangeTeamRoleCell.OnCellClicked = function(self)
...
ChristmasPart2CommonBattleChangeTeamRoleCell.OnEvent = function(self, eventName, arg)
