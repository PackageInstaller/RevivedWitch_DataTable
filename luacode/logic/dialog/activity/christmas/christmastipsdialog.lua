...
-- Command line: -se UTF8 luacode/logic/dialog/activity/christmas/christmastipsdialog.lua 
...
ChristmasTipsDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ChristmasTipsDialog
  ((ChristmasTipsDialog.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

ChristmasTipsDialog.OnCreate = function(self)
...
ChristmasTipsDialog.SetStaticRes = function(self)
  -- function num : 0_2 , upvalues : _ENV, CStringRes
  (self._title):SetText((TextManager.GetText)((CStringRes:GetRecorder(1636)).msgTextID))
end

ChristmasTipsDialog.OnDestroy = function(self)
  -- function num : 0_3
end

ChristmasTipsDialog.OnBackBtnClicked = function(self)
  -- function num : 0_4
  self:Destroy()
end

ChristmasTipsDialog.SetData = function(self, textID)
...
ChristmasTipsDialog.OnCurPosChange = function(self, frame, proportion)
  -- function num : 0_6
