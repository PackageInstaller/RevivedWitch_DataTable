...
-- Command line: -se UTF8 luacode/logic/dialog/activity/chrismascall/shopgoodscellhelper.lua 
...
local RoleTypeId = 27
ShopGoodsCellHelper.Ctor = function(self, rootElement, indexNum)
...
ShopGoodsCellHelper.RefreshCell = function(self, data, shopID)
