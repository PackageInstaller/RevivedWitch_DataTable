...
-- Command line: -se UTF8 luacode/logic/dialog/activity/aprilfoolsday/shopgoodscell.lua 
...
ShopGoodsCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ShopGoodsCell, _ENV
...
ShopGoodsCell.RefreshCell = function(self, data)
  -- function num : 0_3 , upvalues : _ENV, Item, SkinTypeId, CImagePathTable, CSugarShopOpen, CCurrencySymbol, CStringRes
  self._data = data
...
ShopGoodsCell.OnCellClicked = function(self)
  ...
  if (self._bm):IsShopOpen() and ((self._data).iteminfo).goodRemain ~= 0 then
    if (self._data).isrmt == 0 then
