...
-- Command line: -se UTF8 luacode/logic/dialog/activity/aprilfoolsday/fashionbuydialog.lua 
...
FashionBuyDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : FashionBuyDialog, _ENV
  ((FashionBuyDialog.super).Ctor)(self, ...)
  self._groupName = "Modal"
  self._handler = nil
  self._modelHandle = nil
  self._moneyType = {DataCommon.DiamodID, DataCommon.FashionID}
  self._roleData = nil
  self._fashionName = ""
  self._roleName = ""
