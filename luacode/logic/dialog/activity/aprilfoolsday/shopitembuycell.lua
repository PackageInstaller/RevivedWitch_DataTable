...
-- Command line: -se UTF8 luacode/logic/dialog/activity/aprilfoolsday/shopitembuycell.lua 
...
ShopItemBuyCell.OnCellClicked = function(self)
  -- function num : 0_4 , upvalues : ItemTypeEnum, _ENV, SkinTypeId, CSkinItem
  ...
  if (self._item):GetItemType() == ItemTypeEnum.EQUIP then
    ...
    if (self._item):GetItemTypeId() == SkinTypeId then
