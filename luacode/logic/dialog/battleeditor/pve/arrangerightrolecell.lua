...
-- Command line: -se UTF8 luacode/logic/dialog/battleeditor/pve/arrangerightrolecell.lua 
...
ArrangeRightRoleCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ArrangeRightRoleCell
  ((ArrangeRightRoleCell.super).Ctor)(self, ...)
end

ArrangeRightRoleCell.OnCreate = function(self)
  -- function num : 0_1
...
ArrangeRightRoleCell.OnDestroy = function(self)
  -- function num : 0_2
end

ArrangeRightRoleCell.RefreshCell = function(self, data)
...
ArrangeRightRoleCell.OnEvent = function(self, eventName, arg)
  -- function num : 0_4
...
ArrangeRightRoleCell.OnBeginDrag = function(self, args)
  -- function num : 0_5
...
ArrangeRightRoleCell.OnDrag = function(self, args)
  -- function num : 0_6
  (self._delegate):OnRightCellDrag(args.position)
end

ArrangeRightRoleCell.OnEndDrag = function(self, args)
  -- function num : 0_7
  (self._delegate):OnRightCellEndDrag(args.position)
end

ArrangeRightRoleCell.OnCellClicked = function(self, args)
  -- function num : 0_8
  (self._delegate):SetSelectedID((self._cellData).id)
end
