...
-- Command line: -se UTF8 luacode/logic/dialog/battleeditor/pvp/arrangepvpleftdialog.lua 
...
ArrangePVPLeftDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ArrangePVPLeftDialog
...
ArrangePVPLeftDialog.OnCreate = function(self, root)
...
ArrangePVPLeftDialog.OnDestroy = function(self)
...
ArrangePVPLeftDialog.LoadLocalData = function(self)
...
ArrangePVPLeftDialog.ShowAttribute = function(self, roleConfigId)
  -- function num : 0_4 , upvalues : RoleConfigTable, CSkillShow_Role, _ENV
...
ArrangePVPLeftDialog.GetSelectedID = function(self)
  -- function num : 0_9
  return self._selectedId
end

ArrangePVPLeftDialog.OnLeftCellSelected = function(self, posId)
...
ArrangePVPLeftDialog.OnRightCellBeginDrag = function(self, screenPosition)
...
ArrangePVPLeftDialog.OnRightCellDrag = function(self, screenPosition)
...
ArrangePVPLeftDialog.OnRightCellEndDrag = function(self, screenPosition)
  -- function num : 0_13
  if self._dragCell then
    (self._dragCell):Destroy()
    ;
...
ArrangePVPLeftDialog.OnClearClicked = function(self, arg)
...
ArrangePVPLeftDialog.OnSelfClicked = function(self)
...
ArrangePVPLeftDialog.OnBackBtnClicked = function(self)
  -- function num : 0_16 , upvalues : _ENV
  (DialogManager.DestroySingletonDialog)("battleeditor.pvp.arrangepvpleftdialog")
end

ArrangePVPLeftDialog.OnLeftCellDrop = function(self, arg, selfLuaWindow, sourceLuaWindow)
...
ArrangePVPLeftDialog.OnLeftCellClicked = function(self, arg, selfLuaWindow)
  -- function num : 0_18
  local posIndex = selfLuaWindow:GetUserData()
  self:OnLeftCellSelected(posIndex)
end
