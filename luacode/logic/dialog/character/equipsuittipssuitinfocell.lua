...
-- Command line: -se UTF8 luacode/logic/dialog/character/equipsuittipssuitinfocell.lua 
...
EquipSuitTipsSuitInfoCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipSuitTipsSuitInfoCell
  ((EquipSuitTipsSuitInfoCell.super).Ctor)(self, ...)
end

EquipSuitTipsSuitInfoCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipSuitTipsSuitInfoCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipSuitTipsSuitInfoCell.RefreshCell = function(self, data)
