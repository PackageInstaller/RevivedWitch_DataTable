...
-- Command line: -se UTF8 luacode/logic/dialog/character/equipsuittipssuitskillcell.lua 
...
EquipSuitTipsSuitSkillCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipSuitTipsSuitSkillCell
  ((EquipSuitTipsSuitSkillCell.super).Ctor)(self, ...)
end

EquipSuitTipsSuitSkillCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipSuitTipsSuitSkillCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipSuitTipsSuitSkillCell.RefreshCell = function(self, data)
