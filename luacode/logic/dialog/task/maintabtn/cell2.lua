...
-- Command line: -se UTF8 luacode/logic/dialog/task/maintabtn/cell2.lua 
...
Cell2.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : Cell2
  ((Cell2.super).Ctor)(self, ...)
end

Cell2.OnCreate = function(self)
  -- function num : 0_1
...
Cell2.OnDestroy = function(self)
  -- function num : 0_2
end

Cell2.RefreshCell = function(self, data)
  -- function num : 0_3
end

Cell2.OnTabBtnClicked = function(self)
  -- function num : 0_4
  (self._delegate):ToPage(self._cellData)
end

Cell2.OnEvent = function(self, eventName, arg)
