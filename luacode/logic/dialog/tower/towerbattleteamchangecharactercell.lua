...
-- Command line: -se UTF8 luacode/logic/dialog/tower/towerbattleteamchangecharactercell.lua 
...
TowerBattleTeamChangeCharacterCell.Ctor = function(self, ...)
  -- function num : 0_1 , upvalues : TowerBattleTeamChangeCharacterCell
  ((TowerBattleTeamChangeCharacterCell.super).Ctor)(self, ...)
  self._sameTag = false
  self._groupName = "Cell"
end

TowerBattleTeamChangeCharacterCell.OnCreate = function(self)
  -- function num : 0_2
...
TowerBattleTeamChangeCharacterCell.OnDestroy = function(self)
  -- function num : 0_3
end

TowerBattleTeamChangeCharacterCell.RefreshCell = function(self, data)
...
TowerBattleTeamChangeCharacterCell.IsSameWithTeamRoles = function(self)
...
TowerBattleTeamChangeCharacterCell.OnCellClicked = function(self)
...
TowerBattleTeamChangeCharacterCell.OnCellLongPress = function(self)
...
TowerBattleTeamChangeCharacterCell.OnEvent = function(self, eventName, arg)
