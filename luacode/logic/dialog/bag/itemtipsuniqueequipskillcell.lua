...
-- Command line: -se UTF8 luacode/logic/dialog/bag/itemtipsuniqueequipskillcell.lua 
...
ItemTipsUniqueEquipSkillCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : ItemTipsUniqueEquipSkillCell
  ((ItemTipsUniqueEquipSkillCell.super).Ctor)(self, ...)
end

ItemTipsUniqueEquipSkillCell.OnCreate = function(self)
  -- function num : 0_1
...
ItemTipsUniqueEquipSkillCell.OnDestroy = function(self)
  -- function num : 0_2
end

ItemTipsUniqueEquipSkillCell.RefreshCell = function(self, data)
  -- function num : 0_3
