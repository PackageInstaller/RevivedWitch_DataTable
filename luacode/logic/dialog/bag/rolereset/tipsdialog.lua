...
-- Command line: -se UTF8 luacode/logic/dialog/bag/rolereset/tipsdialog.lua 
...
TipDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : TipDialog
  ((TipDialog.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

TipDialog.OnCreate = function(self)
...
TipDialog.SetStaticRes = function(self)
  -- function num : 0_2 , upvalues : _ENV
  (self._title):SetText((TextManager.GetText)(701832))
end

TipDialog.OnDestroy = function(self)
  -- function num : 0_3
end

TipDialog.OnBackBtnClicked = function(self)
  -- function num : 0_4
  self:Destroy()
end

TipDialog.SetData = function(self, textID)
...
TipDialog.OnCurPosChange = function(self, frame, proportion)
  -- function num : 0_6
