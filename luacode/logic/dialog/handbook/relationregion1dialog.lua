...
-- Command line: -se UTF8 luacode/logic/dialog/handbook/relationregion1dialog.lua 
...
RelationRegion1Dialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : RelationRegion1Dialog, _ENV
...
RelationRegion1Dialog.OnCreate = function(self)
...
RelationRegion1Dialog.OnDestroy = function(self)
  -- function num : 0_2
...
RelationRegion1Dialog.Init = function(self, deleget, dialogIndex)
  -- function num : 0_3
  self._deleget = deleget
  self._dialogIndex = dialogIndex
end

RelationRegion1Dialog.OnBtnClicked = function(self, index)
...
RelationRegion1Dialog.OnAnimationStateExit = function(self, handler, stateName, normalizedTime)
...
RelationRegion1Dialog.OnEnable = function(self)
  -- function num : 0_6
  (self._animator):SetInteger("state", 1)
end

RelationRegion1Dialog.ToBookList = function(self)
  -- function num : 0_7
  (self._deleget):ToBookList()
  self:Destroy()
end

RelationRegion1Dialog.OnBackBtnClicked = function(self)
  -- function num : 0_8
  self:Destroy()
end
