...
-- Command line: -se UTF8 luacode/logic/dialog/handbook/relationregion3dialog.lua 
...
RelationRegion3Dialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : RelationRegion3Dialog, _ENV
...
RelationRegion3Dialog.OnCreate = function(self)
...
RelationRegion3Dialog.OnDestroy = function(self)
  -- function num : 0_2
...
RelationRegion3Dialog.Init = function(self, deleget, dialogIndex)
  -- function num : 0_3
  self._deleget = deleget
  self._dialogIndex = dialogIndex
end

RelationRegion3Dialog.OnBtnClicked = function(self, index)
...
RelationRegion3Dialog.OnAnimationStateExit = function(self, handler, stateName, normalizedTime)
...
RelationRegion3Dialog.OnEnable = function(self)
  -- function num : 0_6
  (self._animator):SetInteger("state", 1)
end

RelationRegion3Dialog.ToBookList = function(self)
  -- function num : 0_7
  (self._deleget):ToBookList()
  self:Destroy()
end

RelationRegion3Dialog.OnBackBtnClicked = function(self)
  -- function num : 0_8
  self:Destroy()
end
