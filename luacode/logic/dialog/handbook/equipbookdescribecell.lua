...
-- Command line: -se UTF8 luacode/logic/dialog/handbook/equipbookdescribecell.lua 
...
EquipBookDescribeCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : EquipBookDescribeCell
  ((EquipBookDescribeCell.super).Ctor)(self, ...)
end

EquipBookDescribeCell.OnCreate = function(self)
  -- function num : 0_1
...
EquipBookDescribeCell.OnDestroy = function(self)
  -- function num : 0_2
end

EquipBookDescribeCell.RefreshCell = function(self, data)
