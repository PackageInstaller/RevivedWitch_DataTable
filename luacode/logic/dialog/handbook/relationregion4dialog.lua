...
-- Command line: -se UTF8 luacode/logic/dialog/handbook/relationregion4dialog.lua 
...
RelationRegion4Dialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : RelationRegion4Dialog, _ENV
...
RelationRegion4Dialog.OnCreate = function(self)
...
RelationRegion4Dialog.OnDestroy = function(self)
  -- function num : 0_2
...
RelationRegion4Dialog.Init = function(self, deleget, dialogIndex)
  -- function num : 0_3
  self._deleget = deleget
  self._dialogIndex = dialogIndex
end

RelationRegion4Dialog.OnBtnClicked = function(self, index)
...
RelationRegion4Dialog.OnAnimationStateExit = function(self, handler, stateName, normalizedTime)
...
RelationRegion4Dialog.OnEnable = function(self)
  -- function num : 0_6
  (self._animator):SetInteger("state", 1)
end

RelationRegion4Dialog.ToBookList = function(self)
  -- function num : 0_7
  (self._deleget):ToBookList()
  self:Destroy()
end

RelationRegion4Dialog.OnBackBtnClicked = function(self)
  -- function num : 0_8
  self:Destroy()
end
