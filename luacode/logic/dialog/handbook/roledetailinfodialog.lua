...
-- Command line: -se UTF8 luacode/logic/dialog/handbook/roledetailinfodialog.lua 
...
RoleDetailInfoDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : RoleDetailInfoDialog
  ((RoleDetailInfoDialog.super).Ctor)(self, ...)
  self._groupName = "Modal"
end

RoleDetailInfoDialog.OnCreate = function(self)
...
RoleDetailInfoDialog.OnDestroy = function(self)
...
RoleDetailInfoDialog.OnRefreshRoleGood = function(self, notification)
...
RoleDetailInfoDialog.OnRefreshReceiveAward = function(self, notification)
...
RoleDetailInfoDialog.OnRefreshUniqueEquipPanel = function(self)
  -- function num : 0_5
  (self._uniqueEquipBtn):SetActive((self._role):GetUniqueEquipId())
end

RoleDetailInfoDialog.AddLevelUpEffect = function(self)
  -- function num : 0_6 , upvalues : _ENV
  (self._levelUpEffect):AddEffectSync((EffectUtil.GetAssetBundleNameAndAssetName)(1115))
end

RoleDetailInfoDialog.RefreshPanel = function(self, roleID)
...
RoleDetailInfoDialog.Refresh = function(self, roleID, npcID)
...
RoleDetailInfoDialog.RefreshTabsRedDot = function(self)
...
RoleDetailInfoDialog.OnTabBtnClick = function(self, index)
...
RoleDetailInfoDialog.DidToPage = function(self, helper, index)
...
RoleDetailInfoDialog.CellAtIndex = function(self, helper, index)
...
RoleDetailInfoDialog.SetVoiceAndLines2 = function(self, roleID, fashionID, tableKey, index, contentId, animation, playHandBook)
...
RoleDetailInfoDialog.SetVoiceIdNil = function(self, auto)
...
RoleDetailInfoDialog.OnAnimationStateExit = function(self, handle, stateName, normalizedTime)
  -- function num : 0_15
...
RoleDetailInfoDialog.OnCuePlayEnd = function(self, notification)
...
RoleDetailInfoDialog.OnLiHuiClicked = function(self, onInitial)
...
RoleDetailInfoDialog.OnLive2DPointerDown = function(self, posName, roleID, fashionID, touchRecordList)
...
RoleDetailInfoDialog.CacheGiveItemId = function(self, itemId)
  -- function num : 0_19
  self._giveItemId = itemId
end

RoleDetailInfoDialog.RefreshByRoleId = function(self, roleID)
  -- function num : 0_20 , upvalues : _ENV, TabType
...
RoleDetailInfoDialog.OnLeftArrowClick = function(self)
    ...
    if (DialogManager.GetDialog)("character.basecharacterlistalldialog") then
      ...
      do
        ...
        if dialog then
          ...
          if len > 1 then
            local leftPos, curPos, pos = nil, nil, nil
            ...
            do
              if leftPos and curPos and leftPos < curPos then
                pos = leftPos
              end
              if not pos then
                for i = len, curPos, -1 do
                  if ((NekoData.BehaviorManager).BM_AllRoles):GetRoleIsUnlock(((roleBookListTab._listByConditions)[i]):GetRoleId()) and curPos < i then
                    pos = i
                    break
                  end
                end
...
RoleDetailInfoDialog.OnRightArrowClick = function(self)
    ...
    if (DialogManager.GetDialog)("character.basecharacterlistalldialog") then
      ...
      do
        ...
        if dialog then
          ...
          local len = #roleBookListTab._listByConditions
          if len > 1 then
            local rightPos, curPos, pos = nil, nil, nil
            for i,v in ipairs(roleBookListTab._listByConditions) do
              if v:GetRoleId() == (self._role):GetRoleId() then
                curPos = i
              end
...
RoleDetailInfoDialog.OnRoleChangeStateExit = function(self, arg1, arg2)
  -- function num : 0_23
...
RoleDetailInfoDialog.OnUniqueEquipBtnClicked = function(self)
...
RoleDetailInfoDialog.OnBackBtnClicked = function(self)
  -- function num : 0_25
  self:Destroy()
end

RoleDetailInfoDialog.OnMenuBtnClicked = function(self)
  -- function num : 0_26 , upvalues : _ENV
  (DialogManager.CreateSingletonDialog)("fastmenu.fastmenudialog")
end

RoleDetailInfoDialog.OnCutoverBtnClick = function(self)
