...
-- Command line: -se UTF8 luacode/logic/dialog/handbook/relationregion5dialog.lua 
...
RelationRegion5Dialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : RelationRegion5Dialog, _ENV
...
RelationRegion5Dialog.OnCreate = function(self)
...
RelationRegion5Dialog.OnDestroy = function(self)
  -- function num : 0_2
...
RelationRegion5Dialog.Init = function(self, deleget, dialogIndex)
  -- function num : 0_3
  self._deleget = deleget
  self._dialogIndex = dialogIndex
end

RelationRegion5Dialog.OnBtnClicked = function(self, index)
...
RelationRegion5Dialog.OnAnimationStateExit = function(self, handler, stateName, normalizedTime)
...
RelationRegion5Dialog.OnEnable = function(self)
  -- function num : 0_6
  (self._animator):SetInteger("state", 1)
end

RelationRegion5Dialog.ToBookList = function(self)
  -- function num : 0_7
  (self._deleget):ToBookList()
  self:Destroy()
end

RelationRegion5Dialog.OnBackBtnClicked = function(self)
  -- function num : 0_8
  self:Destroy()
end
