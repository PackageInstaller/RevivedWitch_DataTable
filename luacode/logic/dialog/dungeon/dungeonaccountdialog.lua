...
-- Command line: -se UTF8 luacode/logic/dialog/dungeon/dungeonaccountdialog.lua 
...
DungeonAccountDialog.SetData = function(self)
...
DungeonAccountDialog.OnNextClicked = function(self)
