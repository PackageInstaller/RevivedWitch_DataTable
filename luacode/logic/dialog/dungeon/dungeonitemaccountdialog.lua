...
-- Command line: -se UTF8 luacode/logic/dialog/dungeon/dungeonitemaccountdialog.lua 
...
DungeonItemAccountDialog.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : DungeonItemAccountDialog
...
DungeonItemAccountDialog.OnCreate = function(self)
  -- function num : 0_1
  self._width = (self:GetRootWindow()):GetRectSize()
end

DungeonItemAccountDialog.OnDestroy = function(self)
...
DungeonItemAccountDialog.SetData = function(self, protocol)
...
DungeonItemAccountDialog.ProcessData = function(self)
...
DungeonItemAccountDialog.OnRefresh = function(self)
