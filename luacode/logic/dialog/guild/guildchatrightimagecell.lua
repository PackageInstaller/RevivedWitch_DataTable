...
-- Command line: -se UTF8 luacode/logic/dialog/guild/guildchatrightimagecell.lua 
...
GuildChatRightImageCell.Ctor = function(self, ...)
  -- function num : 0_1 , upvalues : GuildChatRightImageCell
  ((GuildChatRightImageCell.super).Ctor)(self, ...)
end

GuildChatRightImageCell.OnCreate = function(self)
  -- function num : 0_2
...
GuildChatRightImageCell.RefreshCell = function(self, data)
...
GuildChatRightImageCell.OnPhotoClicked = function(self)
