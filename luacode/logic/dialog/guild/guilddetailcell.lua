...
-- Command line: -se UTF8 luacode/logic/dialog/guild/guilddetailcell.lua 
...
GuildDetailCell.Ctor = function(self, ...)
  -- function num : 0_1 , upvalues : GuildDetailCell
  ((GuildDetailCell.super).Ctor)(self, ...)
end

GuildDetailCell.OnCreate = function(self)
  -- function num : 0_2
...
GuildDetailCell.RefreshCell = function(self, data)
...
GuildDetailCell.OnPhotoClicked = function(self)
