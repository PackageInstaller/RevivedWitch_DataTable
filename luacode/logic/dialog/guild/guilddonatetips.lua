...
-- Command line: -se UTF8 luacode/logic/dialog/guild/guilddonatetips.lua 
...
GuildDonateTips.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : GuildDonateTips
  ((GuildDonateTips.super).Ctor)(self, ...)
  self._groupName = "Tip"
end

GuildDonateTips.OnCreate = function(self)
  -- function num : 0_1
...
GuildDonateTips.OnDestroy = function(self)
  -- function num : 0_2
end

GuildDonateTips.Init = function(self)
...
GuildDonateTips.OnBackBtnClicked = function(self)
  -- function num : 0_4
  self:Destroy()
end
