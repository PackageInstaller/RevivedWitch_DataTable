...
-- Command line: -se UTF8 luacode/logic/dialog/teamedit/changeteamroledialog.lua 
...
ChangeTeamRoleDialog.Ctor = function(self, ...)
  -- function num : 0_1 , upvalues : ChangeTeamRoleDialog
...
ChangeTeamRoleDialog.OnCreate = function(self)
...
ChangeTeamRoleDialog.OnDestroy = function(self)
...
ChangeTeamRoleDialog.Refresh = function(self)
  -- function num : 0_4
  self:ScreeningAndSorting()
end

ChangeTeamRoleDialog.OnRefresh = function(self, notification)
  -- function num : 0_5
  self:Refresh()
  self:RefreshDownPanel()
end

ChangeTeamRoleDialog.RefreshFashion = function(self)
  -- function num : 0_6
  self:OnRefresh()
end
...
ChangeTeamRoleDialog.OnSkillUnlock = function(self)
  -- function num : 0_8 , upvalues : RefreshSkillPanel
  RefreshSkillPanel(self)
end

ChangeTeamRoleDialog.OnUniqueEquipLevelUp = function(self, notification)
  -- function num : 0_9
...
ChangeTeamRoleDialog.RefreshDownPanel = function(self)
...
ChangeTeamRoleDialog.SetFilterCondition = function(self, condition)
  -- function num : 0_11
...
ChangeTeamRoleDialog.Init = function(self, curTeam, curStationInfo, isTowerBattle)
...
ChangeTeamRoleDialog.OnSkill1Clicked = function(self)
...
ChangeTeamRoleDialog.OnSkill2Clicked = function(self)
...
ChangeTeamRoleDialog.OnCellLongPress = function(self)
...
ChangeTeamRoleDialog.OnConfirmBtnClicked = function(self)
...
ChangeTeamRoleDialog.ConfirmFunction = function(self)
...
ChangeTeamRoleDialog.SetSelectedID = function(self, str, roleKey)
  -- function num : 0_18
...
ChangeTeamRoleDialog.GetNumByRoleId = function(self, id)
...
ChangeTeamRoleDialog.ScreeningAndSorting = function(self)
...
ChangeTeamRoleDialog.OnFilterBtnClick = function(self)
...
ChangeTeamRoleDialog.OnLevelBtnClick = function(self)
...
ChangeTeamRoleDialog.OnSortBtnClick = function(self)
...
ChangeTeamRoleDialog.OnLockBtnClick = function(self)
  -- function num : 0_24
...
ChangeTeamRoleDialog.SetSortCriteriaNameId = function(self, nameId)
...
ChangeTeamRoleDialog.SetScreeningConditions = function(self, screeningConditions)
  -- function num : 0_26
  self._screeningConditions = screeningConditions
  self:ScreeningAndSorting()
end

ChangeTeamRoleDialog.NumberOfCell = function(self, frame)
  -- function num : 0_27
  return #self._listByConditions
end

ChangeTeamRoleDialog.CellAtIndex = function(self, frame)
  -- function num : 0_28
...
ChangeTeamRoleDialog.DataAtIndex = function(self, frame, index)
  -- function num : 0_29
  return (self._listByConditions)[index]
end

ChangeTeamRoleDialog.OnCurPosChange = function(self, frame, proportion)
  -- function num : 0_30
...
ChangeTeamRoleDialog.OnBackBtnClicked = function(self)
  -- function num : 0_31
  self:Destroy()
end

ChangeTeamRoleDialog.OnMenuBtnClicked = function(self)
  -- function num : 0_32 , upvalues : _ENV
  (DialogManager.CreateSingletonDialog)("fastmenu.fastmenudialog")
end

ChangeTeamRoleDialog.ReturnRoleList = function(self)
...
ChangeTeamRoleDialog.SetSupportVocationTable = function(self, supportVocationTable)
...
ChangeTeamRoleDialog.SendCUpdateUISortType = function(self)
