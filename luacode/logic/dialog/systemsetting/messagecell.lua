...
-- Command line: -se UTF8 luacode/logic/dialog/systemsetting/messagecell.lua 
...
MessageCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : MessageCell
  ((MessageCell.super).Ctor)(self, ...)
end

MessageCell.OnCreate = function(self)
  -- function num : 0_1 , upvalues : _ENV, CNotice
...
MessageCell.OnDestroy = function(self)
  -- function num : 0_2
end

MessageCell.RefreshCell = function(self)
  -- function num : 0_3
end

local SchedulingEveryDayLoginWorker = function()
  -- function num : 0_4 , upvalues : CNotice, _ENV, SchedulingPushStaticFunctions
...
MessageCell.OnEveryDayLoginBtnClicked = function(self)
  -- function num : 0_5 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingEveryDayLoginWorker
  ...
  if (self._everyDayLoginBtn):IsSelected() then
    ...
    -- function num : 0_5_0 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingEveryDayLoginWorker, self, key
    local value = 0
    ;
...
local SchedulingSpiritFullWorker = function()
  -- function num : 0_6 , upvalues : CNotice, _ENV, CSpirit, SchedulingPushStaticFunctions
...
MessageCell.OnSpiritBtnClicked = function(self)
  -- function num : 0_7 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingSpiritFullWorker
  ...
  if (self._spiritBtn):IsSelected() then
    if not ((NekoData.BehaviorManager).BM_Game):GetIfHaveAskForNotificationPermission() then
      if not (SchedulingPushStaticFunctions.AreNotificationsEnabled)() then
        ((NekoData.BehaviorManager).BM_Message):AddSecondConfirmDialog(109, nil, function()
    -- function num : 0_7_0 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingSpiritFullWorker, self, key
    local value = 0
    ;
    ((NekoData.DataManager).DM_Game):SetIfHaveAskForNotificationPermission(1)
    ;
...
local SchedulingActivityExploreWorker = function(slots)
  -- function num : 0_8 , upvalues : CNotice, _ENV, SlotStateEnum, SchedulingPushStaticFunctions
...
MessageCell.OnActivityExploreBtnClicked = function(self)
  -- function num : 0_9 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingActivityExploreWorker
  ...
  if (self._activityExploreBtn):IsSelected() then
    if not ((NekoData.BehaviorManager).BM_Game):GetIfHaveAskForNotificationPermission() then
      if not (SchedulingPushStaticFunctions.AreNotificationsEnabled)() then
        ((NekoData.BehaviorManager).BM_Message):AddSecondConfirmDialog(109, nil, function()
    -- function num : 0_9_0 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingActivityExploreWorker, slots, self, key
    local value = 0
    ;
    ((NekoData.DataManager).DM_Game):SetIfHaveAskForNotificationPermission(1)
    ;
...
MessageCell.OnDispatchBtnClicked = function(self)
  -- function num : 0_10 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingEveryDayLoginWorker
  ...
  if (self._dispatchSwitchBtn):IsSelected() then
    if not ((NekoData.BehaviorManager).BM_Game):GetIfHaveAskForNotificationPermission() then
      if not (SchedulingPushStaticFunctions.AreNotificationsEnabled)() then
        ((NekoData.BehaviorManager).BM_Message):AddSecondConfirmDialog(109, nil, function()
    -- function num : 0_10_0 , upvalues : _ENV, SchedulingPushStaticFunctions, SchedulingEveryDayLoginWorker, self, key
    local value = 0
    ;
    ((NekoData.DataManager).DM_Game):SetIfHaveAskForNotificationPermission(1)
    ;
