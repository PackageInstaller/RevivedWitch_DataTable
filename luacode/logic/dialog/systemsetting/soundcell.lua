...
-- Command line: -se UTF8 luacode/logic/dialog/systemsetting/soundcell.lua 
...
SoundCell.Ctor = function(self, ...)
  -- function num : 0_0 , upvalues : SoundCell
  ((SoundCell.super).Ctor)(self, ...)
  self._soundToggleList = {}
end

SoundCell.OnCreate = function(self)
  -- function num : 0_1
  for i = 1, 4 do
    do
...
SoundCell.OnDestroy = function(self)
  -- function num : 0_2
end

SoundCell.RefreshCell = function(self)
...
SoundCell.OnValueChanged = function(self, index)
