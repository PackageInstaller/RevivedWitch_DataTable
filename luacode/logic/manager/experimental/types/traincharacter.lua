...
-- Command line: -se UTF8 luacode/logic/manager/experimental/types/traincharacter.lua 
...
TrainCharacter.Ctor = function(self, roleId, isAttacker)
...
TrainCharacter.Destroy = function(self)
...
TrainCharacter.IsAttacker = function(self)
  -- function num : 0_2
  return self._isAttacker
end

TrainCharacter.GetId = function(self)
  -- function num : 0_3
  return self._roleId
end

TrainCharacter.Clone = function(self)
  -- function num : 0_4 , upvalues : _ENV
  return clone(self)
end

TrainCharacter.CreatePlayer = function(self, pointObject)
  -- function num : 0_5 , upvalues : TransformStaticFunctions, YardSceneHelper, BoxColiderStaticFunctions, EventTriggerHelper, StateEventTriggerHelper, AnimationHelper, _ENV
  ...
  do
    ...
    -- function num : 0_5_0 , upvalues : _ENV, total, proportion, AnimationHelper, self
...
TrainCharacter.InitZPosition = function(self, z)
  -- function num : 0_6 , upvalues : _ENV, TransformStaticFunctions
...
TrainCharacter.SetMoveRange = function(self, pointObject)
  -- function num : 0_7 , upvalues : BoxColiderStaticFunctions
...
TrainCharacter.GetMoveRange = function(self)
  -- function num : 0_8
  return self._moveRange
end

TrainCharacter.LoadBehavior = function(self)
...
TrainCharacter.BeginDragYardCharacter = function(self)
  -- function num : 0_10 , upvalues : AnimationHelper
  self._dragTag = true
...
TrainCharacter.EndDragYardCharacter = function(self)
  -- function num : 0_11
  self._dragTag = false
  self._startFreeFall = 0
end

TrainCharacter.SetClickParam = function(self, intData)
  -- function num : 0_12 , upvalues : SceneObjectClick
...
TrainCharacter.SetDeltaMovePosition = function(self, x, y, z)
...
TrainCharacter.SetMovePositionSpeed = function(self, x, y, z)
  -- function num : 0_14 , upvalues : RigidbodyStaticFunctions
  if self._gameObject then
    (RigidbodyStaticFunctions.SetMovePositionSpeed)(self._gameObject, x, y, z)
  end
end

TrainCharacter.GetPosition = function(self)
  -- function num : 0_15 , upvalues : TransformStaticFunctions
  if self._gameObject then
    local x, y, z = (TransformStaticFunctions.GetPosition)(self._gameObject)
    return {x = x, y = y, z = z}
  end
...
TrainCharacter.IsState = function(self, type)
  -- function num : 0_16
  do return type == self._type end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

TrainCharacter.IsArriveBorder = function(self)
  -- function num : 0_17
  do return self._arriveBorderDirection ~= 0 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

TrainCharacter.Walk = function(self, same, minTime, maxTime)
  -- function num : 0_18
  self:WalkOrStand(1, same * self._arriveBorderDirection, minTime, maxTime)
end

TrainCharacter.Stand = function(self, same, minTime, maxTime)
  -- function num : 0_19
  self:WalkOrStand(0, same * self._direction, minTime, maxTime)
end

TrainCharacter.WalkOrStand = function(self, type, direction, minTime, maxTime)
  -- function num : 0_20 , upvalues : _ENV, sitLimit
  self._type = type
...
TrainCharacter.OnUpdate = function(self, notification)
...
TrainCharacter.OnTriggerEnterEvent = function(self, colliderObj, curPosition)
  -- function num : 0_22
...
TrainCharacter.OnTriggerExitEvent = function(self, colliderObj, curPosition)
  -- function num : 0_23
  if colliderObj == self._leftColliderObject or colliderObj == self._rightColliderObject then
    self._arriveBorderDirection = 0
  end
...
TrainCharacter.DragYardCharacter = function(self, x, y, z)
  -- function num : 0_24 , upvalues : AnimationHelper, _ENV
  local deltaX = 0
  local deltaY = 0
...
TrainCharacter.ClickCharacter = function(self)
  -- function num : 0_25 , upvalues : AnimationHelper
  if self._isAttacker then
    return 
  end
...
TrainCharacter.OnClickAnimationEnd = function(self)
  -- function num : 0_26
...
TrainCharacter.SetUiCell = function(self, cell)
  -- function num : 0_27
  self._uiCell = cell
end
