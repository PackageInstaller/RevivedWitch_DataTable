...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/ranking/watermelonpaneldata.lua 
...
WatermelonPanelData.Ctor = function(self)
  -- function num : 0_0
  self.roleIdList = {}
  self.roleLvList = {}
  self.roleBreakList = {}
...
WatermelonPanelData.Marshal = function(self, buffer)
...
WatermelonPanelData.Unmarshal = function(self, buffer)
