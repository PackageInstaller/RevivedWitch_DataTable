...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/ranking/undecidedroadpaneldata.lua 
...
UnDecidedRoadPanelData.Ctor = function(self)
  -- function num : 0_0
  self.roleIdList = {}
  self.roleLvList = {}
  self.roleBreakList = {}
...
UnDecidedRoadPanelData.Marshal = function(self, buffer)
...
UnDecidedRoadPanelData.Unmarshal = function(self, buffer)
