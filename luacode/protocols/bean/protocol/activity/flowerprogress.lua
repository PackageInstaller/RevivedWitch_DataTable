...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/flowerprogress.lua 
...
flowerProgress.Ctor = function(self)
  -- function num : 0_0
  self.rewardIds = {}
end

flowerProgress.Marshal = function(self, buffer)
...
flowerProgress.Unmarshal = function(self, buffer)
