...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/challengerecord.lua 
...
ChallengeRecord.Ctor = function(self)
  -- function num : 0_0
  self.roleIdList = {}
  self.roleLvList = {}
  self.roleBreakList = {}
...
ChallengeRecord.Marshal = function(self, buffer)
...
ChallengeRecord.Unmarshal = function(self, buffer)
