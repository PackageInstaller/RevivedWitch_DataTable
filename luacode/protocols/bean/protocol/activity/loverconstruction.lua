...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/loverconstruction.lua 
...
LoverConstruction.Ctor = function(self)
  -- function num : 0_0
  self.event = {}
  self.locked = {}
  self.autoExplore = {}
...
LoverConstruction.Marshal = function(self, buffer)
...
LoverConstruction.Unmarshal = function(self, buffer)
