...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/loverevent.lua 
...
loverevent.Ctor = function(self)
  -- function num : 0_0
  self.events = {}
  self.autoExplore = {}
end

loverevent.Marshal = function(self, buffer)
...
loverevent.Unmarshal = function(self, buffer)
