...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/christmasconstruction.lua 
...
ChristmasConstruction.Ctor = function(self)
  -- function num : 0_0
  self.event = {}
  self.locked = {}
  self.autoExplore = {}
...
ChristmasConstruction.Marshal = function(self, buffer)
...
ChristmasConstruction.Unmarshal = function(self, buffer)
