...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/pointinfo.lua 
...
PointInfo.Marshal = function(self, buffer)
...
PointInfo.Unmarshal = function(self, buffer)
