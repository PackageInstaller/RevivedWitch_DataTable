...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/summerevent.lua 
...
summerevent.Ctor = function(self)
  -- function num : 0_0
  self.events = {}
  self.autoExplore = {}
end

summerevent.Marshal = function(self, buffer)
...
summerevent.Unmarshal = function(self, buffer)
