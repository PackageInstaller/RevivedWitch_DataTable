...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/unlockitem.lua 
...
unlockItem.Ctor = function(self)
  -- function num : 0_0
end

unlockItem.Marshal = function(self, buffer)
...
unlockItem.Unmarshal = function(self, buffer)
