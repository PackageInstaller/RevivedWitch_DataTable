...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/christmasevent.lua 
...
christmasevent.Ctor = function(self)
  -- function num : 0_0
  self.events = {}
  self.autoExplore = {}
end

christmasevent.Marshal = function(self, buffer)
...
christmasevent.Unmarshal = function(self, buffer)
