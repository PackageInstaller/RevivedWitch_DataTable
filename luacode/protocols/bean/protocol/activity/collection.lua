...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/collection.lua 
...
Collection.LOCK = 0
Collection.Ctor = function(self)
  -- function num : 0_0
end

Collection.Marshal = function(self, buffer)
...
Collection.Unmarshal = function(self, buffer)
