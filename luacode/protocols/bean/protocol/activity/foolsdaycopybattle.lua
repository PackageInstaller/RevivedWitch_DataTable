...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/activity/foolsdaycopybattle.lua 
...
FoolsDayCopyBattle.Ctor = function(self)
  -- function num : 0_0
  self.difficult = {}
end

FoolsDayCopyBattle.Marshal = function(self, buffer)
...
FoolsDayCopyBattle.Unmarshal = function(self, buffer)
