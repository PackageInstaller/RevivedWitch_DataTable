...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/battle/usedequipskills.lua 
...
UsedEquipSkills.Ctor = function(self)
  -- function num : 0_0
  self.skillIds = {}
end

UsedEquipSkills.Marshal = function(self, buffer)
...
UsedEquipSkills.Unmarshal = function(self, buffer)
