...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/battle/itembox.lua 

-- params : ...
-- function num : 0 , upvalues : _ENV
local ProtocolBufferStaticFunctions = ((CS.PixelNeko).Net).ProtocolBufferStaticFunctions
local ItemBox = dataclass("ItemBox")
ItemBox.Ctor = function(self)
  -- function num : 0_0
  self.items = {}
end

ItemBox.Marshal = function(self, buffer)
...
ItemBox.Unmarshal = function(self, buffer)
