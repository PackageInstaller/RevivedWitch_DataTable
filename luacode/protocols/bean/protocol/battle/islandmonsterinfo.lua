...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/battle/islandmonsterinfo.lua 
...
IslandMonsterInfo.Ctor = function(self)
  -- function num : 0_0
end

IslandMonsterInfo.Marshal = function(self, buffer)
...
IslandMonsterInfo.Unmarshal = function(self, buffer)
