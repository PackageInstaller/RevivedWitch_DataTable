...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/battle/exploreinstance.lua 
...
ExploreInstance.Ctor = function(self)
  -- function num : 0_0
end

ExploreInstance.Marshal = function(self, buffer)
...
ExploreInstance.Unmarshal = function(self, buffer)
