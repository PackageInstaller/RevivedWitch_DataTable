...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/card/rolepool.lua 
...
RolePool.rate = 0
RolePool.Ctor = function(self)
  -- function num : 0_0
  self.ids = {}
end

RolePool.Marshal = function(self, buffer)
...
RolePool.Unmarshal = function(self, buffer)
