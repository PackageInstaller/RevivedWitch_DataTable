...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/card/drawcardinfo.lua 
...
DrawCardInfo.Ctor = function(self)
  -- function num : 0_0
  self.cardList = {}
  self.cardNumList = {}
end

DrawCardInfo.Marshal = function(self, buffer)
...
DrawCardInfo.Unmarshal = function(self, buffer)
