...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/yard/light.lua 
...
Light.key = 0
Light.itemId = 0
Light.Ctor = function(self)
  -- function num : 0_0
end

Light.Marshal = function(self, buffer)
...
Light.Unmarshal = function(self, buffer)
