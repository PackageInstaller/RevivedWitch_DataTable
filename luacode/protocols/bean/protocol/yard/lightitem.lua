...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/yard/lightitem.lua 
...
LightItem.Ctor = function(self)
  -- function num : 0_0
end

LightItem.Marshal = function(self, buffer)
...
LightItem.Unmarshal = function(self, buffer)
