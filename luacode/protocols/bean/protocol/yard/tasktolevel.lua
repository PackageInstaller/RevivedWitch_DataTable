...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/yard/tasktolevel.lua 
...
TaskToLevel.Ctor = function(self)
  -- function num : 0_0
end

TaskToLevel.Marshal = function(self, buffer)
...
TaskToLevel.Unmarshal = function(self, buffer)
