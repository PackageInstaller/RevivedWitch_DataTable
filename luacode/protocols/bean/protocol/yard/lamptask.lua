...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/yard/lamptask.lua 
...
LampTask.Ctor = function(self)
  -- function num : 0_0
end

LampTask.Marshal = function(self, buffer)
...
LampTask.Unmarshal = function(self, buffer)
