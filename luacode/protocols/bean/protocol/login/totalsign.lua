...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/login/totalsign.lua 
...
TotalSign.Ctor = function(self)
  -- function num : 0_0
  self.awards = {}
end

TotalSign.Marshal = function(self, buffer)
...
TotalSign.Unmarshal = function(self, buffer)
