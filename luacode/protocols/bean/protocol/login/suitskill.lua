...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/login/suitskill.lua 

-- params : ...
-- function num : 0 , upvalues : _ENV
local ProtocolBufferStaticFunctions = ((CS.PixelNeko).Net).ProtocolBufferStaticFunctions
local SuitSkill = dataclass("SuitSkill")
SuitSkill.Ctor = function(self)
  -- function num : 0_0
  self.skillIds = {}
end

SuitSkill.Marshal = function(self, buffer)
...
SuitSkill.Unmarshal = function(self, buffer)
