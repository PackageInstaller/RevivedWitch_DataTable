...
-- Command line: -se UTF8 luacode/protocols/bean/protocol/task/condition.lua 
...
Condition.Ctor = function(self)
  -- function num : 0_0
end

Condition.Marshal = function(self, buffer)
...
Condition.Unmarshal = function(self, buffer)
