...
-- Command line: -se UTF8 luacode/protocols/def/protocol/chat/ssendchatmsg.lua 
...
SSendChatMsg.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SSendChatMsg, _ENV
  ((SSendChatMsg.super).Ctor)(self, client)
  self.baseUserData = ((require("protocols.bean.protocol.chat.baseuserdata")).Create)()
  self.hyperlinks = {}
end

SSendChatMsg.Marshal = function(self, buffer)
...
SSendChatMsg.Unmarshal = function(self, buffer)
