...
-- Command line: -se UTF8 luacode/protocols/def/protocol/chat/ssendemojiinfo.lua 
...
SSendEmojiInfo.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SSendEmojiInfo
  ((SSendEmojiInfo.super).Ctor)(self, client)
  self.hadEmoji = {}
end

SSendEmojiInfo.Marshal = function(self, buffer)
...
SSendEmojiInfo.Unmarshal = function(self, buffer)
