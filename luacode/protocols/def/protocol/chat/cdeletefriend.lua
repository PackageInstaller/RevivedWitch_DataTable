...
-- Command line: -se UTF8 luacode/protocols/def/protocol/chat/cdeletefriend.lua 
...
CDeleteFriend.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CDeleteFriend
  ((CDeleteFriend.super).Ctor)(self, client)
end

CDeleteFriend.Marshal = function(self, buffer)
...
CDeleteFriend.Unmarshal = function(self, buffer)
