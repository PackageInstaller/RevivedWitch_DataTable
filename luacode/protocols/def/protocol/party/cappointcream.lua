...
-- Command line: -se UTF8 luacode/protocols/def/protocol/party/cappointcream.lua 
...
CAppointCream.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CAppointCream
  ((CAppointCream.super).Ctor)(self, client)
end

CAppointCream.Marshal = function(self, buffer)
...
CAppointCream.Unmarshal = function(self, buffer)
