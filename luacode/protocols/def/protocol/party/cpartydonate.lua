...
-- Command line: -se UTF8 luacode/protocols/def/protocol/party/cpartydonate.lua 
...
CPartyDonate.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CPartyDonate
  ((CPartyDonate.super).Ctor)(self, client)
  self.donateItems = {}
end

CPartyDonate.Marshal = function(self, buffer)
...
CPartyDonate.Unmarshal = function(self, buffer)
