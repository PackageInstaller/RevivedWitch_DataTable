...
-- Command line: -se UTF8 luacode/protocols/def/protocol/party/sshowpartydonateprocess.lua 
...
SShowPartyDonateProcess.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SShowPartyDonateProcess
  ((SShowPartyDonateProcess.super).Ctor)(self, client)
  self.receiveAwards = {}
end

SShowPartyDonateProcess.Marshal = function(self, buffer)
...
SShowPartyDonateProcess.Unmarshal = function(self, buffer)
