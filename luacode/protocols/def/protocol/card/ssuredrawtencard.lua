...
-- Command line: -se UTF8 luacode/protocols/def/protocol/card/ssuredrawtencard.lua 
...
SSureDrawTenCard.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SSureDrawTenCard
  ((SSureDrawTenCard.super).Ctor)(self, client)
  self.items = {}
end

SSureDrawTenCard.Marshal = function(self, buffer)
...
SSureDrawTenCard.Unmarshal = function(self, buffer)
