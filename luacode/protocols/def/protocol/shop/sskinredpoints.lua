...
-- Command line: -se UTF8 luacode/protocols/def/protocol/shop/sskinredpoints.lua 
...
SSkinRedPoints.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SSkinRedPoints
  ((SSkinRedPoints.super).Ctor)(self, client)
  self.looked = {}
end

SSkinRedPoints.Marshal = function(self, buffer)
...
SSkinRedPoints.Unmarshal = function(self, buffer)
