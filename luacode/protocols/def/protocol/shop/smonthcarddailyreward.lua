...
-- Command line: -se UTF8 luacode/protocols/def/protocol/shop/smonthcarddailyreward.lua 
...
SMonthCardDailyReward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SMonthCardDailyReward
  ((SMonthCardDailyReward.super).Ctor)(self, client)
  self.dailyReward = {}
end

SMonthCardDailyReward.Marshal = function(self, buffer)
...
SMonthCardDailyReward.Unmarshal = function(self, buffer)
