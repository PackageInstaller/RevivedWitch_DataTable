...
-- Command line: -se UTF8 luacode/protocols/def/protocol/shop/smonthcardstate.lua 
...
SMonthCardState.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SMonthCardState
  ((SMonthCardState.super).Ctor)(self, client)
  self.monthcards = {}
end

SMonthCardState.Marshal = function(self, buffer)
...
SMonthCardState.Unmarshal = function(self, buffer)
