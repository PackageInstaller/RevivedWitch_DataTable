...
-- Command line: -se UTF8 luacode/protocols/def/protocol/shop/sgetfirstrechargegiftstate.lua 
...
SGetFirstRechargeGiftState.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SGetFirstRechargeGiftState
  ((SGetFirstRechargeGiftState.super).Ctor)(self, client)
  self.giftsState = {}
end

SGetFirstRechargeGiftState.Marshal = function(self, buffer)
...
SGetFirstRechargeGiftState.Unmarshal = function(self, buffer)
