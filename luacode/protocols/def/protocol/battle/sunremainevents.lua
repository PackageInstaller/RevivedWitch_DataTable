...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sunremainevents.lua 
...
SUnRemainEvents.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SUnRemainEvents
  ((SUnRemainEvents.super).Ctor)(self, client)
  self.events = {}
end

SUnRemainEvents.Marshal = function(self, buffer)
...
SUnRemainEvents.Unmarshal = function(self, buffer)
