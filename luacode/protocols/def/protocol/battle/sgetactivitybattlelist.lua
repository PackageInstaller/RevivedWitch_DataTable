...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sgetactivitybattlelist.lua 
...
SGetActivityBattleList.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SGetActivityBattleList
  ((SGetActivityBattleList.super).Ctor)(self, client)
  self.battleNodes = {}
end

SGetActivityBattleList.Marshal = function(self, buffer)
...
SGetActivityBattleList.Unmarshal = function(self, buffer)
