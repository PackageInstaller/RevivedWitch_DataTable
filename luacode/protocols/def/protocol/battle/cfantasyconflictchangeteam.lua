...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/cfantasyconflictchangeteam.lua 
...
CFantasyConflictChangeTeam.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CFantasyConflictChangeTeam
  ((CFantasyConflictChangeTeam.super).Ctor)(self, client)
  self.team = {}
end

CFantasyConflictChangeTeam.Marshal = function(self, buffer)
...
CFantasyConflictChangeTeam.Unmarshal = function(self, buffer)
