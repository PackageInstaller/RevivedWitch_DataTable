...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sislandtouchaltar.lua 
...
SIslandTouchAltar.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SIslandTouchAltar
  ((SIslandTouchAltar.super).Ctor)(self, client)
  self.hpInfo = {}
end

SIslandTouchAltar.Marshal = function(self, buffer)
...
SIslandTouchAltar.Unmarshal = function(self, buffer)
