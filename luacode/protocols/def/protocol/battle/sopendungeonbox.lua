...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sopendungeonbox.lua 
...
SOpenDungeonBox.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SOpenDungeonBox
  ((SOpenDungeonBox.super).Ctor)(self, client)
  self.items = {}
end

SOpenDungeonBox.Marshal = function(self, buffer)
...
SOpenDungeonBox.Unmarshal = function(self, buffer)
