...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/senemylineupscell.lua 
...
SEnemyLineupsCell.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SEnemyLineupsCell
  ((SEnemyLineupsCell.super).Ctor)(self, client)
  self.lineupsInfo = {}
end

SEnemyLineupsCell.Marshal = function(self, buffer)
...
SEnemyLineupsCell.Unmarshal = function(self, buffer)
