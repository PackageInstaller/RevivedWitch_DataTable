...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sscrollsceneinfo.lua 
...
SScrollSceneInfo.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SScrollSceneInfo
  ((SScrollSceneInfo.super).Ctor)(self, client)
  self.scrollSceneInfo = {}
end

SScrollSceneInfo.Marshal = function(self, buffer)
...
SScrollSceneInfo.Unmarshal = function(self, buffer)
