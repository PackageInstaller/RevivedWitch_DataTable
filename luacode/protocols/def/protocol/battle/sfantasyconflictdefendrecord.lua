...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sfantasyconflictdefendrecord.lua 
...
SFantasyConflictDefendRecord.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SFantasyConflictDefendRecord
  ((SFantasyConflictDefendRecord.super).Ctor)(self, client)
  self.enemyRoleList = {}
end

SFantasyConflictDefendRecord.Marshal = function(self, buffer)
...
SFantasyConflictDefendRecord.Unmarshal = function(self, buffer)
