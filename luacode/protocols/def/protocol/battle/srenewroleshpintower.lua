...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/srenewroleshpintower.lua 
...
SRenewRolesHPinTower.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SRenewRolesHPinTower
  ((SRenewRolesHPinTower.super).Ctor)(self, client)
  self.status = {}
end

SRenewRolesHPinTower.Marshal = function(self, buffer)
...
SRenewRolesHPinTower.Unmarshal = function(self, buffer)
