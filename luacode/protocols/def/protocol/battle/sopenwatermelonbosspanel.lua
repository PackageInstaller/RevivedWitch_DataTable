...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sopenwatermelonbosspanel.lua 
...
SOpenWatermelonBossPanel.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SOpenWatermelonBossPanel
  ((SOpenWatermelonBossPanel.super).Ctor)(self, client)
  self.bosses = {}
end

SOpenWatermelonBossPanel.Marshal = function(self, buffer)
...
SOpenWatermelonBossPanel.Unmarshal = function(self, buffer)
