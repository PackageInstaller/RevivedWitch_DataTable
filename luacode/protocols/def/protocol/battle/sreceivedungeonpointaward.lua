...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sreceivedungeonpointaward.lua 
...
SReceiveDungeonPointAward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SReceiveDungeonPointAward
  ((SReceiveDungeonPointAward.super).Ctor)(self, client)
  self.items = {}
end

SReceiveDungeonPointAward.Marshal = function(self, buffer)
...
SReceiveDungeonPointAward.Unmarshal = function(self, buffer)
