...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/strigglesuccess.lua 
...
STriggleSuccess.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : STriggleSuccess
  ((STriggleSuccess.super).Ctor)(self, client)
end

STriggleSuccess.Marshal = function(self, buffer)
...
STriggleSuccess.Unmarshal = function(self, buffer)
