...
-- Command line: -se UTF8 luacode/protocols/def/protocol/battle/sdungeonoption.lua 
...
SDungeonOption.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SDungeonOption
  ((SDungeonOption.super).Ctor)(self, client)
  self.items = {}
end

SDungeonOption.Marshal = function(self, buffer)
...
SDungeonOption.Unmarshal = function(self, buffer)
