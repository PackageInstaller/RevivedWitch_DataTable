...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/sexchangeitems.lua 
...
SExchangeItems.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SExchangeItems
  ((SExchangeItems.super).Ctor)(self, client)
  self.itemList = {}
end

SExchangeItems.Marshal = function(self, buffer)
...
SExchangeItems.Unmarshal = function(self, buffer)
