...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/sdecomposeequips.lua 
...
SDecomposeEquips.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SDecomposeEquips
  ((SDecomposeEquips.super).Ctor)(self, client)
  self.equipKeys = {}
end

SDecomposeEquips.Marshal = function(self, buffer)
...
SDecomposeEquips.Unmarshal = function(self, buffer)
