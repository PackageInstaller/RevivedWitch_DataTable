...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/sgetskinoverview.lua 
...
SGetSkinOverview.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SGetSkinOverview
  ((SGetSkinOverview.super).Ctor)(self, client)
  self.skins = {}
end

SGetSkinOverview.Marshal = function(self, buffer)
...
SGetSkinOverview.Unmarshal = function(self, buffer)
