...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/cchangeequipment.lua 
...
CChangeEquipment.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CChangeEquipment
  ((CChangeEquipment.super).Ctor)(self, client)
  self.equipToRole = {}
end

CChangeEquipment.Marshal = function(self, buffer)
...
CChangeEquipment.Unmarshal = function(self, buffer)
