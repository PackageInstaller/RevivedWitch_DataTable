...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/cbreakthroughequip.lua 
...
CBreakThroughEquip.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CBreakThroughEquip
  ((CBreakThroughEquip.super).Ctor)(self, client)
  self.costEquipKeys = {}
end

CBreakThroughEquip.Marshal = function(self, buffer)
...
CBreakThroughEquip.Unmarshal = function(self, buffer)
