...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/sreceiveitems.lua 
...
SReceiveItems.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SReceiveItems
  ((SReceiveItems.super).Ctor)(self, client)
  self.itemList = {}
end

SReceiveItems.Marshal = function(self, buffer)
...
SReceiveItems.Unmarshal = function(self, buffer)
