...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/spreviewequipattrs.lua 
...
SPreviewEquipAttrs.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SPreviewEquipAttrs
  ((SPreviewEquipAttrs.super).Ctor)(self, client)
  self.lvAttrs = {}
end

SPreviewEquipAttrs.Marshal = function(self, buffer)
...
SPreviewEquipAttrs.Unmarshal = function(self, buffer)
