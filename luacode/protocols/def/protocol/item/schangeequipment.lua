...
-- Command line: -se UTF8 luacode/protocols/def/protocol/item/schangeequipment.lua 
...
SChangeEquipment.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SChangeEquipment
...
SChangeEquipment.Marshal = function(self, buffer)
...
SChangeEquipment.Unmarshal = function(self, buffer)
