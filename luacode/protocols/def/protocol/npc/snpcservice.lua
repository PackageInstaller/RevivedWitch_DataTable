...
-- Command line: -se UTF8 luacode/protocols/def/protocol/npc/snpcservice.lua 
...
SNpcService.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SNpcService
  ((SNpcService.super).Ctor)(self, client)
  self.childServiceIds = {}
end

SNpcService.Marshal = function(self, buffer)
...
SNpcService.Unmarshal = function(self, buffer)
