...
-- Command line: -se UTF8 luacode/protocols/def/protocol/user/sstartwitchskillguide.lua 
...
SStartWitchSkillGuide.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SStartWitchSkillGuide
  ((SStartWitchSkillGuide.super).Ctor)(self, client)
  self.skillItemIds = {}
end

SStartWitchSkillGuide.Marshal = function(self, buffer)
...
SStartWitchSkillGuide.Unmarshal = function(self, buffer)
