...
-- Command line: -se UTF8 luacode/protocols/def/protocol/user/cchangesysconfig.lua 
...
CChangeSysConfig.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CChangeSysConfig
  ((CChangeSysConfig.super).Ctor)(self, client)
  self.configs = {}
end

CChangeSysConfig.Marshal = function(self, buffer)
...
CChangeSysConfig.Unmarshal = function(self, buffer)
