...
-- Command line: -se UTF8 luacode/protocols/def/protocol/task/sweekactiveaward.lua 
...
SWeekActiveAward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SWeekActiveAward
  ((SWeekActiveAward.super).Ctor)(self, client)
  self.awards = {}
end

SWeekActiveAward.Marshal = function(self, buffer)
...
SWeekActiveAward.Unmarshal = function(self, buffer)
