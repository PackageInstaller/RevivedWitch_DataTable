...
-- Command line: -se UTF8 luacode/protocols/def/protocol/task/caddbadges.lua 
...
CAddBadges.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CAddBadges
  ((CAddBadges.super).Ctor)(self, client)
  self.badges = {}
end

CAddBadges.Marshal = function(self, buffer)
...
CAddBadges.Unmarshal = function(self, buffer)
