...
-- Command line: -se UTF8 luacode/protocols/def/protocol/task/staskaward.lua 
...
STaskAward.gold = 0
STaskAward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : STaskAward
  ((STaskAward.super).Ctor)(self, client)
  self.itemList = {}
end

STaskAward.Marshal = function(self, buffer)
...
STaskAward.Unmarshal = function(self, buffer)
