...
-- Command line: -se UTF8 luacode/protocols/def/protocol/task/saddbadges.lua 
...
SAddBadges.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SAddBadges
  ((SAddBadges.super).Ctor)(self, client)
  self.badges = {}
end

SAddBadges.Marshal = function(self, buffer)
...
SAddBadges.Unmarshal = function(self, buffer)
