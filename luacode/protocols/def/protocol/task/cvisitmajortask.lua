...
-- Command line: -se UTF8 luacode/protocols/def/protocol/task/cvisitmajortask.lua 
...
CVisitMajorTask.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CVisitMajorTask
  ((CVisitMajorTask.super).Ctor)(self, client)
  self.taskIds = {}
end

CVisitMajorTask.Marshal = function(self, buffer)
...
CVisitMajorTask.Unmarshal = function(self, buffer)
