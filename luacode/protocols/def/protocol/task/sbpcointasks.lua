...
-- Command line: -se UTF8 luacode/protocols/def/protocol/task/sbpcointasks.lua 
...
SBPCoinTasks.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SBPCoinTasks
  ((SBPCoinTasks.super).Ctor)(self, client)
  self.tasks = {}
end

SBPCoinTasks.Marshal = function(self, buffer)
...
SBPCoinTasks.Unmarshal = function(self, buffer)
