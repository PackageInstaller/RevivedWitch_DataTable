...
-- Command line: -se UTF8 luacode/protocols/def/protocol/skill/srefreshwitchskills.lua 
...
SRefreshWitchSkills.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SRefreshWitchSkills
  ((SRefreshWitchSkills.super).Ctor)(self, client)
  self.changedSkills = {}
end

SRefreshWitchSkills.Marshal = function(self, buffer)
  ...
  for key,value in pairs(self.changedSkills) do
    ...
    if not (ProtocolBufferStaticFunctions.WriteInt16)(buffer, R9_PC18) then
      return false
    end
  end
  return true
...
SRefreshWitchSkills.Unmarshal = function(self, buffer)
