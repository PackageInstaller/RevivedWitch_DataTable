...
-- Command line: -se UTF8 luacode/protocols/def/protocol/skill/cselectwitchskills.lua 
...
CSelectWitchSkills.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CSelectWitchSkills
  ((CSelectWitchSkills.super).Ctor)(self, client)
  self.skillItemIds = {}
end

CSelectWitchSkills.Marshal = function(self, buffer)
...
CSelectWitchSkills.Unmarshal = function(self, buffer)
