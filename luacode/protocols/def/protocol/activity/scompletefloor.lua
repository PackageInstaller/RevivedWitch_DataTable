...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/scompletefloor.lua 
...
SCompleteFloor.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SCompleteFloor
  ((SCompleteFloor.super).Ctor)(self, client)
end

SCompleteFloor.Marshal = function(self, buffer)
...
SCompleteFloor.Unmarshal = function(self, buffer)
