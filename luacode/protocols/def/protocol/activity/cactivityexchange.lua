...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/cactivityexchange.lua 
...
CActivityExchange.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CActivityExchange
  ((CActivityExchange.super).Ctor)(self, client)
end

CActivityExchange.Marshal = function(self, buffer)
...
CActivityExchange.Unmarshal = function(self, buffer)
