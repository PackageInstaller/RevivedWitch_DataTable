...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sopenflowerlist.lua 
...
SOpenFlowerList.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SOpenFlowerList
  ((SOpenFlowerList.super).Ctor)(self, client)
  self.flowerProgress = {}
end

SOpenFlowerList.Marshal = function(self, buffer)
...
SOpenFlowerList.Unmarshal = function(self, buffer)
