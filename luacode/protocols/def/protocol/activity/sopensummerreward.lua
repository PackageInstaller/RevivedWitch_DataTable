...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sopensummerreward.lua 
...
SOpenSummerReward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SOpenSummerReward
  ((SOpenSummerReward.super).Ctor)(self, client)
  self.receiveAward = {}
end

SOpenSummerReward.Marshal = function(self, buffer)
...
SOpenSummerReward.Unmarshal = function(self, buffer)
