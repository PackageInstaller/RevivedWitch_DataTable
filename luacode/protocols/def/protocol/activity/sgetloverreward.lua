...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sgetloverreward.lua 
...
SGetLoverReward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SGetLoverReward
  ((SGetLoverReward.super).Ctor)(self, client)
  self.progressReward = {}
end

SGetLoverReward.Marshal = function(self, buffer)
...
SGetLoverReward.Unmarshal = function(self, buffer)
