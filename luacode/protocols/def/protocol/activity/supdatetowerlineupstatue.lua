...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/supdatetowerlineupstatue.lua 
...
SUpdateTowerLineupStatue.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SUpdateTowerLineupStatue
  ((SUpdateTowerLineupStatue.super).Ctor)(self, client)
  self.rolesState = {}
end

SUpdateTowerLineupStatue.Marshal = function(self, buffer)
...
SUpdateTowerLineupStatue.Unmarshal = function(self, buffer)
