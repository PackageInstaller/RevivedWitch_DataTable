...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sopenanniversarydraw.lua 
...
SOpenAnniversaryDraw.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SOpenAnniversaryDraw
  ((SOpenAnniversaryDraw.super).Ctor)(self, client)
  self.award = {}
end

SOpenAnniversaryDraw.Marshal = function(self, buffer)
...
SOpenAnniversaryDraw.Unmarshal = function(self, buffer)
