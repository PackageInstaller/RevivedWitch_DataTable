...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/cgetspringredpacket.lua 
...
CGetSpringRedPacket.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CGetSpringRedPacket
  ((CGetSpringRedPacket.super).Ctor)(self, client)
end

CGetSpringRedPacket.Marshal = function(self, buffer)
...
CGetSpringRedPacket.Unmarshal = function(self, buffer)
