...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sspringbossstate.lua 
...
SSpringBossState.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SSpringBossState
  ((SSpringBossState.super).Ctor)(self, client)
  self.bossList = {}
end

SSpringBossState.Marshal = function(self, buffer)
...
SSpringBossState.Unmarshal = function(self, buffer)
