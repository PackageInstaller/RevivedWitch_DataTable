...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sshareactivity.lua 
...
SShareActivity.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SShareActivity
  ((SShareActivity.super).Ctor)(self, client)
  self.share = {}
end

SShareActivity.Marshal = function(self, buffer)
...
SShareActivity.Unmarshal = function(self, buffer)
