...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/srefreshmazecards.lua 
...
SRefreshMazeCards.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SRefreshMazeCards
  ((SRefreshMazeCards.super).Ctor)(self, client)
  self.cards = {}
end

SRefreshMazeCards.Marshal = function(self, buffer)
...
SRefreshMazeCards.Unmarshal = function(self, buffer)
