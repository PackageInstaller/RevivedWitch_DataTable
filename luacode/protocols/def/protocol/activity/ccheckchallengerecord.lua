...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/ccheckchallengerecord.lua 
...
CCheckChallengeRecord.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CCheckChallengeRecord
  ((CCheckChallengeRecord.super).Ctor)(self, client)
end

CCheckChallengeRecord.Marshal = function(self, buffer)
...
CCheckChallengeRecord.Unmarshal = function(self, buffer)
