...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sopenhalloweeninfo.lua 
...
SOpenHalloweenInfo.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SOpenHalloweenInfo
...
SOpenHalloweenInfo.Marshal = function(self, buffer)
...
SOpenHalloweenInfo.Unmarshal = function(self, buffer)
