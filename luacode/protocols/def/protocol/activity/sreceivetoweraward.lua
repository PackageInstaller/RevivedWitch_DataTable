...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sreceivetoweraward.lua 
...
SReceiveTowerAward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SReceiveTowerAward
  ((SReceiveTowerAward.super).Ctor)(self, client)
  self.items = {}
end

SReceiveTowerAward.Marshal = function(self, buffer)
...
SReceiveTowerAward.Unmarshal = function(self, buffer)
