...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/spassfloorendpoint.lua 
...
SPassFloorEndPoint.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SPassFloorEndPoint
  ((SPassFloorEndPoint.super).Ctor)(self, client)
  self.receiveItems = {}
end

SPassFloorEndPoint.Marshal = function(self, buffer)
...
SPassFloorEndPoint.Unmarshal = function(self, buffer)
