...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sactiveactivities.lua 
...
SActiveActivities.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SActiveActivities
  ((SActiveActivities.super).Ctor)(self, client)
  self.activities = {}
end

SActiveActivities.Marshal = function(self, buffer)
...
SActiveActivities.Unmarshal = function(self, buffer)
