...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/srequestrougetoweropen.lua 
...
SRequestRougeTowerOpen.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SRequestRougeTowerOpen
  ((SRequestRougeTowerOpen.super).Ctor)(self, client)
end

SRequestRougeTowerOpen.Marshal = function(self, buffer)
...
SRequestRougeTowerOpen.Unmarshal = function(self, buffer)
