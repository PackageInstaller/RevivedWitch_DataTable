...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/srefreshfoolsdayroles.lua 
...
SRefreshFoolsDayRoles.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SRefreshFoolsDayRoles
  ((SRefreshFoolsDayRoles.super).Ctor)(self, client)
  self.roles = {}
end

SRefreshFoolsDayRoles.Marshal = function(self, buffer)
...
SRefreshFoolsDayRoles.Unmarshal = function(self, buffer)
