...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/sgetdisplayroominfo.lua 
...
SGetDisplayRoomInfo.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SGetDisplayRoomInfo
  ((SGetDisplayRoomInfo.super).Ctor)(self, client)
  self.masks = {}
end

SGetDisplayRoomInfo.Marshal = function(self, buffer)
...
SGetDisplayRoomInfo.Unmarshal = function(self, buffer)
