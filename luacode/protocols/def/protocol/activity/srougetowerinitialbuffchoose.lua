...
-- Command line: -se UTF8 luacode/protocols/def/protocol/activity/srougetowerinitialbuffchoose.lua 
...
SRougeTowerInitialBuffChoose.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SRougeTowerInitialBuffChoose
  ((SRougeTowerInitialBuffChoose.super).Ctor)(self, client)
  self.buff = {}
end

SRougeTowerInitialBuffChoose.Marshal = function(self, buffer)
...
SRougeTowerInitialBuffChoose.Unmarshal = function(self, buffer)
