...
-- Command line: -se UTF8 luacode/protocols/def/protocol/ranking/sweekchallengeranking.lua 
...
SWeekChallengeRanking.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SWeekChallengeRanking, _ENV
  ((SWeekChallengeRanking.super).Ctor)(self, client)
  self.personRank = ((require("protocols.bean.protocol.ranking.bosschallenge")).Create)()
  self.ranking = {}
end

SWeekChallengeRanking.Marshal = function(self, buffer)
...
SWeekChallengeRanking.Unmarshal = function(self, buffer)
