...
-- Command line: -se UTF8 luacode/protocols/def/protocol/ranking/sundrchallengeranking.lua 
...
SUNDRChallengeRanking.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SUNDRChallengeRanking, _ENV
  ((SUNDRChallengeRanking.super).Ctor)(self, client)
  self.personRank = ((require("protocols.bean.protocol.ranking.undrchallenge")).Create)()
  self.ranking = {}
end

SUNDRChallengeRanking.Marshal = function(self, buffer)
...
SUNDRChallengeRanking.Unmarshal = function(self, buffer)
