...
-- Command line: -se UTF8 luacode/protocols/def/protocol/ranking/ssimplerank.lua 
...
SSimpleRank.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SSimpleRank, _ENV
  ((SSimpleRank.super).Ctor)(self, client)
  self.ranking = {}
  self.playerRanking = ((require("protocols.bean.protocol.ranking.simplerank")).Create)()
end

SSimpleRank.Marshal = function(self, buffer)
...
SSimpleRank.Unmarshal = function(self, buffer)
