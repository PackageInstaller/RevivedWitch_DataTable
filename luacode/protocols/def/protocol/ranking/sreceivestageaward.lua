...
-- Command line: -se UTF8 luacode/protocols/def/protocol/ranking/sreceivestageaward.lua 
...
SReceiveStageAward.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SReceiveStageAward
  ((SReceiveStageAward.super).Ctor)(self, client)
  self.items = {}
end

SReceiveStageAward.Marshal = function(self, buffer)
...
SReceiveStageAward.Unmarshal = function(self, buffer)
