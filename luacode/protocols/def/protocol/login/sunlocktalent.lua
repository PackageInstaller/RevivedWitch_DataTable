...
-- Command line: -se UTF8 luacode/protocols/def/protocol/login/sunlocktalent.lua 
...
SUnlockTalent.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SUnlockTalent
  ((SUnlockTalent.super).Ctor)(self, client)
  self.talentInRow = {}
end

SUnlockTalent.Marshal = function(self, buffer)
...
SUnlockTalent.Unmarshal = function(self, buffer)
