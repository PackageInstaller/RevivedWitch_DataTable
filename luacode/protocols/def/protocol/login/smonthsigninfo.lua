...
-- Command line: -se UTF8 luacode/protocols/def/protocol/login/smonthsigninfo.lua 
...
SMonthSignInfo.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SMonthSignInfo
  ((SMonthSignInfo.super).Ctor)(self, client)
  self.receives = {}
end

SMonthSignInfo.Marshal = function(self, buffer)
...
SMonthSignInfo.Unmarshal = function(self, buffer)
