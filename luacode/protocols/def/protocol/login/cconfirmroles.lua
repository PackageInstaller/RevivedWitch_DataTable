...
-- Command line: -se UTF8 luacode/protocols/def/protocol/login/cconfirmroles.lua 
...
CConfirmRoles.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CConfirmRoles
  ((CConfirmRoles.super).Ctor)(self, client)
  self.roles = {}
end

CConfirmRoles.Marshal = function(self, buffer)
...
CConfirmRoles.Unmarshal = function(self, buffer)
