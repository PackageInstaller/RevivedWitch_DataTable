...
-- Command line: -se UTF8 luacode/protocols/def/protocol/login/cquickrepairroles.lua 
...
CQuickRepairRoles.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CQuickRepairRoles
  ((CQuickRepairRoles.super).Ctor)(self, client)
  self.roleIds = {}
end

CQuickRepairRoles.Marshal = function(self, buffer)
...
CQuickRepairRoles.Unmarshal = function(self, buffer)
