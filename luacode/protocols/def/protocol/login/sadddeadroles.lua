...
-- Command line: -se UTF8 luacode/protocols/def/protocol/login/sadddeadroles.lua 
...
SAddDeadRoles.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SAddDeadRoles
  ((SAddDeadRoles.super).Ctor)(self, client)
  self.deadRoles = {}
end

SAddDeadRoles.Marshal = function(self, buffer)
...
SAddDeadRoles.Unmarshal = function(self, buffer)
