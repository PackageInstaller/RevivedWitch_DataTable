...
-- Command line: -se UTF8 luacode/protocols/def/protocol/yard/smusiccollectionrewardsachieved.lua 
...
SMusicCollectionRewardsAchieved.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : SMusicCollectionRewardsAchieved
  ((SMusicCollectionRewardsAchieved.super).Ctor)(self, client)
  self.musicCollectionRewardsStates = {}
end

SMusicCollectionRewardsAchieved.Marshal = function(self, buffer)
...
SMusicCollectionRewardsAchieved.Unmarshal = function(self, buffer)
