...
-- Command line: -se UTF8 luacode/protocols/def/protocol/yard/crecoveryenergy.lua 
...
CRecoveryEnergy.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CRecoveryEnergy
  ((CRecoveryEnergy.super).Ctor)(self, client)
  self.roles = {}
end

CRecoveryEnergy.Marshal = function(self, buffer)
...
CRecoveryEnergy.Unmarshal = function(self, buffer)
