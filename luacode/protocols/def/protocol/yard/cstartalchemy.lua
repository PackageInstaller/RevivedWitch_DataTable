...
-- Command line: -se UTF8 luacode/protocols/def/protocol/yard/cstartalchemy.lua 
...
CStartAlchemy.Ctor = function(self, client)
  -- function num : 0_0 , upvalues : CStartAlchemy
  ((CStartAlchemy.super).Ctor)(self, client)
end

CStartAlchemy.Marshal = function(self, buffer)
...
CStartAlchemy.Unmarshal = function(self, buffer)
