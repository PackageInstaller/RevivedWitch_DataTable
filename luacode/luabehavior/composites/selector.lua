...
-- Command line: -se UTF8 luacode/luabehavior/composites/selector.lua 
...
Selector.Ctor = function(self)
  -- function num : 0_0 , upvalues : Selector
  ((Selector.super).Ctor)(self)
  self._index = 1
  self._tasks = {}
end

Selector.AddTask = function(self, task)
  -- function num : 0_1 , upvalues : _ENV
  (table.insert)(self._tasks, task)
end

Selector.OnStart = function(self)
  -- function num : 0_2 , upvalues : Selector
  ((Selector.super).OnStart)(self)
  self._index = 1
end

Selector.OnUpdate = function(self, deltaTime)
...
Selector.SelfUpdate = function(self, deltaTime)
...
Selector.GetCheckPoints = function(self)
