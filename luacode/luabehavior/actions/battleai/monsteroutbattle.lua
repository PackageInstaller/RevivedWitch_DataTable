...
-- Command line: -se UTF8 luacode/luabehavior/actions/battleai/monsteroutbattle.lua 
...
MonsterOutBattle.Ctor = function(self, context, typeid, monsterid)
  -- function num : 0_0 , upvalues : MonsterOutBattle, _ENV
...
MonsterOutBattle.OnStart = function(self)
  -- function num : 0_1
end

MonsterOutBattle.OnUpdate = function(self, deltaTime)
...
MonsterOutBattle.OnEnd = function(self)
  -- function num : 0_3
end
